...
#endif`,Xh="gl_FragColor = linearToOutputTexel( gl_FragColor );",jh=`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Xt,depthTest:!1,depthWrite:!1})}function rl(){return new Ct({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Qa(),fragmentShader:`
		...
		`,blending:Xt,depthTest:!1,depthWrite:!1})}function il(){return new Ct({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Qa(),fragmentShader:`
		...
		`,blending:Xt,depthTest:!1,depthWrite:!1})}function Qa(){return`
	...
	`}function rf(i){let e=new WeakMap,t=null;function r(s){if(s&&s.isTexture){const l=s.mapping,c=l===ha||l===da,u=l===ti||l===ri;if(c||u)if(s.isRenderTargetTexture&&s.needsPMREMUpdate===!0){s.needsPMREMUpdate=!1;let f=e.get(s);return t===null&&(t=new el(i)),f=c?t.fromEquirectangular(s,f):t.fromCubemap(s,f),e.set(s,f),f.texture}else{if(e.has(s))return e.get(s).texture;{const f=s.image;if(c&&f&&f.height>0||u&&f&&n(f)){t===null&&(t=new el(i));const d=c?t.fromEquirectangular(s):t.fromCubemap(s);return e.set(s,d),s.addEventListener("dispose",a),d.texture}else return null}}}return s}function n(s){let l=0;const c=6;for(let u=0;u<c;u++)s[u]!==void 0&&l++;return l===c}function a(s){const l=s.target;l.removeEventListener("dispose",a);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:r,dispose:o}}function nf(i){const e={};function t(r){if(e[r]!==void 0)return e[r];let n;switch(r){case"WEBGL_depth_texture":n=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":n=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":n=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":n=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:n=i.getExtension(r)}return e[r]=n,n}return{has:function(r){return t(r)!==null},init:function(r){r.isWebGL2?(t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance")):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(r){const n=t(r);return n===null&&console.warn("THREE.WebGLRenderer: "+r+" extension not supported."),n}}}function af(i,e,t,r){const n={},a=new WeakMap;function o(f){const d=f.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);for(const g in d.morphAttributes){const v=d.morphAttributes[g];for(let m=0,h=v.length;m<h;m++)e.remove(v[m])}d.removeEventListener("dispose",o),delete n[d.id];const p=a.get(d);p&&(e.remove(p),a.delete(d)),r.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function s(f,d){return n[d.id]===!0||(d.addEventListener("dispose",o),n[d.id]=!0,t.memory.geometries++),d}function l(f){const d=f.attributes;for(const g in d)e.update(d[g],i.ARRAY_BUFFER);const p=f.morphAttributes;for(const g in p){const v=p[g];for(let m=0,h=v.length;m<h;m++)e.update(v[m],i.ARRAY_BUFFER)}}function c(f){const d=[],p=f.index,g=f.attributes.position;let v=0;if(p!==null){const S=p.array;v=p.version;for(let x=0,C=S.length;x<C;x+=3){const D=S[x+0],R=S[x+1],A=S[x+2];d.push(D,R,R,A,A,D)}}else if(g!==void 0){const S=g.array;v=g.version;for(let x=0,C=S.length/3-1;x<C;x+=3){const D=x+0,R=x+1,A=x+2;d.push(D,R,R,A,A,D)}}else return;const m=new(So(d)?ko:Ho)(d,1);m.version=v;const h=a.get(f);h&&e.remove(h),a.set(f,m)}function u(f){const d=a.get(f);if(d){const p=f.index;p!==null&&d.version<p.version&&c(f)}else c(f);return a.get(f)}return{get:s,update:l,getWireframeAttribute:u}}function sf(i,e,t,r){const n=r.isWebGL2;let a;function o(p){a=p}let s,l;function c(p){s=p.type,l=p.bytesPerElement}function u(p,g){i.drawElements(a,g,s,p*l),t.update(g,a,1)}function f(p,g,v){if(v===0)return;let m,h;if(n)m=i,h="drawElementsInstanced";else if(m=e.get("ANGLE_instanced_arrays"),h="drawElementsInstancedANGLE",m===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}m[h](a,g,s,p*l,v),t.update(g,a,v)}function d(p,g,v){if(v===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let h=0;h<v;h++)this.render(p[h]/l,g[h]);else{m.multiDrawElementsWEBGL(a,g,0,s,p,0,v);let h=0;for(let S=0;S<v;S++)h+=g[S];t.update(h,a,1)}}this.setMode=o,this.setIndex=c,this.render=u,this.renderInstances=f,this.renderMultiDraw=d}function of(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function r(a,o,s){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=s*(a/3);break;case i.LINES:t.lines+=s*(a/2);break;case i.LINE_STRIP:t.lines+=s*(a-1);break;case i.LINE_LOOP:t.lines+=s*a;break;case i.POINTS:t.points+=s*a;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function n(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:n,update:r}}function lf(i,e){return i[0]-e[0]}function cf(i,e){return Math.abs(e[1])-Math.abs(i[1])}function uf(i,e,t){const r={},n=new Float32Array(8),a=new WeakMap,o=new ht,s=[];for(let c=0;c<8;c++)s[c]=[c,0];function l(c,u,f){const d=c.morphTargetInfluences;if(e.isWebGL2===!0){const p=u.morphAttributes.position||u.morphAttributes.normal||u.morphAttributes.color,g=p!==void 0?p.length:0;let v=a.get(u);if(v===void 0||v.count!==g){let S=function(){ue.dispose(),a.delete(u),u.removeEventListener("dispose",S)};v!==void 0&&v.texture.dispose();const x=u.morphAttributes.position!==void 0,C=u.morphAttributes.normal!==void 0,D=u.morphAttributes.color!==void 0,R=u.morphAttributes.position||[],A=u.morphAttributes.normal||[],Z=u.morphAttributes.color||[];let E=0;x===!0&&(E=1),C===!0&&(E=2),D===!0&&(E=3);let M=u.attributes.position.count*E,k=1;M>e.maxTextureSize&&(k=Math.ceil(M/e.maxTextureSize),M=e.maxTextureSize);const G=new Float32Array(M*k*4*g),ue=new Lo(G,M,k,g);ue.type=Mr,ue.needsUpdate=!0;const L=E*4;for(let F=0;F<g;F++){const V=R[F],j=A[F],X=Z[F],W=M*k*4*F;for(let ee=0;ee<V.count;ee++){const re=ee*L;x===!0&&(o.fromBufferAttribute(V,ee),G[W+re+0]=o.x,G[W+re+1]=o.y,G[W+re+2]=o.z,G[W+re+3]=0),C===!0&&(o.fromBufferAttribute(j,ee),G[W+re+4]=o.x,G[W+re+5]=o.y,G[W+re+6]=o.z,G[W+re+7]=0),D===!0&&(o.fromBufferAttribute(X,ee),G[W+re+8]=o.x,G[W+re+9]=o.y,G[W+re+10]=o.z,G[W+re+11]=X.itemSize===4?o.w:1)}}v={count:g,texture:ue,size:new be(M,k)},a.set(u,v),u.addEventListener("dispose",S)}let m=0;for(let S=0;S<d.length;S++)m+=d[S];const h=u.morphTargetsRelative?1:1-m;f.getUniforms().setValue(i,"morphTargetBaseInfluence",h),f.getUniforms().setValue(i,"morphTargetInfluences",d),f.getUniforms().setValue(i,"morphTargetsTexture",v.texture,t),f.getUniforms().setValue(i,"morphTargetsTextureSize",v.size)}else{const p=d===void 0?0:d.length;let g=r[u.id];if(g===void 0||g.length!==p){g=[];for(let x=0;x<p;x++)g[x]=[x,0];r[u.id]=g}for(let x=0;x<p;x++){const C=g[x];C[0]=x,C[1]=d[x]}g.sort(cf);for(let x=0;x<8;x++)x<p&&g[x][1]?(s[x][0]=g[x][0],s[x][1]=g[x][1]):(s[x][0]=Number.MAX_SAFE_INTEGER,s[x][1]=0);s.sort(lf);const v=u.morphAttributes.position,m=u.morphAttributes.normal;let h=0;for(let x=0;x<8;x++){const C=s[x],D=C[0],R=C[1];D!==Number.MAX_SAFE_INTEGER&&R?(v&&u.getAttribute("morphTarget"+x)!==v[D]&&u.setAttribute("morphTarget"+x,v[D]),m&&u.getAttribute("morphNormal"+x)!==m[D]&&u.setAttribute("morphNormal"+x,m[D]),n[x]=R,h+=R):(v&&u.hasAttribute("morphTarget"+x)===!0&&u.deleteAttribute("morphTarget"+x),m&&u.hasAttribute("morphNormal"+x)===!0&&u.deleteAttribute("morphNormal"+x),n[x]=0)}const S=u.morphTargetsRelative?1:1-h;f.getUniforms().setValue(i,"morphTargetBaseInfluence",S),f.getUniforms().setValue(i,"morphTargetInfluences",n)}}return{update:l}}function hf(i,e,t,r){let n=new WeakMap;function a(l){const c=r.render.frame,u=l.geometry,f=e.get(l,u);if(n.get(f)!==c&&(e.update(f),n.set(f,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",s)===!1&&l.addEventListener("dispose",s),n.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),n.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;n.get(d)!==c&&(d.update(),n.set(d,c))}return f}function o(){n=new WeakMap}function s(l){const c=l.target;c.removeEventListener("dispose",s),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:a,dispose:o}}class nl extends Lt{constructor(e,t,r,n,a,o,s,l,c,u){if(u=u!==void 0?u:Br,u!==Br&&u!==ii)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");r===void 0&&u===Br&&(r=Er),r===void 0&&u===ii&&(r=Fr),super(null,n,a,o,s,l,u,r,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=s!==void 0?s:Et,this.minFilter=l!==void 0?l:Et,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const al=new Lt,sl=new nl(1,1);sl.compareFunction=yo;const ol=new Lo,ll=new Ku,cl=new Ko,ul=[],hl=[],dl=new Float32Array(16),pl=new Float32Array(9),fl=new Float32Array(4);function wi(i,e,t){const r=i[0];if(r<=0||r>0)return i;const n=e*t;let a=ul[n];if(a===void 0&&(a=new Float32Array(n),ul[n]=a),e!==0){r.toArray(a,0);for(let o=1,s=0;o!==e;++o)s+=t,i[o].toArray(a,s)}return a}function ot(i,e){if(i.length!==e.length)return!1;for(let t=0,r=i.length;t<r;t++)if(i[t]!==e[t])return!1;return!0}function lt(i,e){for(let t=0,r=e.length;t<r;t++)i[t]=e[t]}function zn(i,e){let t=hl[e];t===void 0&&(t=new Int32Array(e),hl[e]=t);for(let r=0;r!==e;++r)t[r]=i.allocateTextureUnit();return t}function df(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function pf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ot(t,e))return;i.uniform2fv(this.addr,e),lt(t,e)}}function ff(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(ot(t,e))return;i.uniform3fv(this.addr,e),lt(t,e)}}function mf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ot(t,e))return;i.uniform4fv(this.addr,e),lt(t,e)}}function gf(i,e){const t=this.cache,r=e.elements;if(r===void 0){if(ot(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),lt(t,e)}else{if(ot(t,r))return;fl.set(r),i.uniformMatrix2fv(this.addr,!1,fl),lt(t,r)}}function _f(i,e){const t=this.cache,r=e.elements;if(r===void 0){if(ot(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),lt(t,e)}else{if(ot(t,r))return;pl.set(r),i.uniformMatrix3fv(this.addr,!1,pl),lt(t,r)}}function vf(i,e){const t=this.cache,r=e.elements;if(r===void 0){if(ot(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),lt(t,e)}else{if(ot(t,r))return;dl.set(r),i.uniformMatrix4fv(this.addr,!1,dl),lt(t,r)}}function xf(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function yf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ot(t,e))return;i.uniform2iv(this.addr,e),lt(t,e)}}function bf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ot(t,e))return;i.uniform3iv(this.addr,e),lt(t,e)}}function Ef(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ot(t,e))return;i.uniform4iv(this.addr,e),lt(t,e)}}function Mf(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Sf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ot(t,e))return;i.uniform2uiv(this.addr,e),lt(t,e)}}function Tf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ot(t,e))return;i.uniform3uiv(this.addr,e),lt(t,e)}}function wf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ot(t,e))return;i.uniform4uiv(this.addr,e),lt(t,e)}}function Af(i,e,t){const r=this.cache,n=t.allocateTextureUnit();r[0]!==n&&(i.uniform1i(this.addr,n),r[0]=n);const a=this.type===i.SAMPLER_2D_SHADOW?sl:al;t.setTexture2D(e||a,n)}function Rf(i,e,t){const r=this.cache,n=t.allocateTextureUnit();r[0]!==n&&(i.uniform1i(this.addr,n),r[0]=n),t.setTexture3D(e||ll,n)}function Cf(i,e,t){const r=this.cache,n=t.allocateTextureUnit();r[0]!==n&&(i.uniform1i(this.addr,n),r[0]=n),t.setTextureCube(e||cl,n)}function Lf(i,e,t){const r=this.cache,n=t.allocateTextureUnit();r[0]!==n&&(i.uniform1i(this.addr,n),r[0]=n),t.setTexture2DArray(e||ol,n)}function Pf(i){switch(i){case 5126:return df;case 35664:return pf;case 35665:return ff;case 35666:return mf;case 35674:return gf;case 35675:return _f;case 35676:return vf;case 5124:case 35670:return xf;case 35667:case 35671:return yf;case 35668:case 35672:return bf;case 35669:case 35673:return Ef;case 5125:return Mf;case 36294:return Sf;case 36295:return Tf;case 36296:return wf;case 35678:case 36198:case 36298:case 36306:case 35682:return Af;case 35679:case 36299:case 36307:return Rf;case 35680:case 36300:case 36308:case 36293:return Cf;case 36289:case 36303:case 36311:case 36292:return Lf}}function Uf(i,e){i.uniform1fv(this.addr,e)}function Df(i,e){const t=wi(e,this.size,2);i.uniform2fv(this.addr,t)}function If(i,e){const t=wi(e,this.size,3);i.uniform3fv(this.addr,t)}function Nf(i,e){const t=wi(e,this.size,4);i.uniform4fv(this.addr,t)}function Of(i,e){const t=wi(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Ff(i,e){const t=wi(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Bf(i,e){const t=wi(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function zf(i,e){i.uniform1iv(this.addr,e)}function Hf(i,e){i.uniform2iv(this.addr,e)}function kf(i,e){i.uniform3iv(this.addr,e)}function Gf(i,e){i.uniform4iv(this.addr,e)}function Vf(i,e){i.uniform1uiv(this.addr,e)}function Wf(i,e){i.uniform2uiv(this.addr,e)}function Xf(i,e){i.uniform3uiv(this.addr,e)}function jf(i,e){i.uniform4uiv(this.addr,e)}function qf(i,e,t){const r=this.cache,n=e.length,a=zn(t,n);ot(r,a)||(i.uniform1iv(this.addr,a),lt(r,a));for(let o=0;o!==n;++o)t.setTexture2D(e[o]||al,a[o])}function Yf(i,e,t){const r=this.cache,n=e.length,a=zn(t,n);ot(r,a)||(i.uniform1iv(this.addr,a),lt(r,a));for(let o=0;o!==n;++o)t.setTexture3D(e[o]||ll,a[o])}function Kf(i,e,t){const r=this.cache,n=e.length,a=zn(t,n);ot(r,a)||(i.uniform1iv(this.addr,a),lt(r,a));for(let o=0;o!==n;++o)t.setTextureCube(e[o]||cl,a[o])}function Zf(i,e,t){const r=this.cache,n=e.length,a=zn(t,n);ot(r,a)||(i.uniform1iv(this.addr,a),lt(r,a));for(let o=0;o!==n;++o)t.setTexture2DArray(e[o]||ol,a[o])}function Jf(i){switch(i){case 5126:return Uf;case 35664:return Df;case 35665:return If;case 35666:return Nf;case 35674:return Of;case 35675:return Ff;case 35676:return Bf;case 5124:case 35670:return zf;case 35667:case 35671:return Hf;case 35668:case 35672:return kf;case 35669:case 35673:return Gf;case 5125:return Vf;case 36294:return Wf;case 36295:return Xf;case 36296:return jf;case 35678:case 36198:case 36298:case 36306:case 35682:return qf;case 35679:case 36299:case 36307:return Yf;case 35680:case 36300:case 36308:case 36293:return Kf;case 36289:case 36303:case 36311:case 36292:return Zf}}class Qf{constructor(e,t,r){this.id=e,this.addr=r,this.cache=[],this.type=t.type,this.setValue=Pf(t.type)}}class $f{constructor(e,t,r){this.id=e,this.addr=r,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Jf(t.type)}}class em{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,r){const n=this.seq;for(let a=0,o=n.length;a!==o;++a){const s=n[a];s.setValue(e,t[s.id],r)}}}const $a=/(\w+)(\])?(\[|\.)?/g;function ml(i,e){i.seq.push(e),i.map[e.id]=e}function tm(i,e,t){const r=i.name,n=r.length;for($a.lastIndex=0;;){const a=$a.exec(r),o=$a.lastIndex;let s=a[1];const l=a[2]==="]",c=a[3];if(l&&(s=s|0),c===void 0||c==="["&&o+2===n){ml(t,c===void 0?new Qf(s,i,e):new $f(s,i,e));break}else{let u=t.map[s];u===void 0&&(u=new em(s),ml(t,u)),t=u}}}class Hn{constructor(e,t){this.seq=[],this.map={};const r=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let n=0;n<r;++n){const a=e.getActiveUniform(t,n),o=e.getUniformLocation(t,a.name);tm(a,o,this)}}setValue(e,t,r,n){const a=this.map[t];a!==void 0&&a.setValue(e,r,n)}setOptional(e,t,r){const n=t[r];n!==void 0&&this.setValue(e,r,n)}static upload(e,t,r,n){for(let a=0,o=t.length;a!==o;++a){const s=t[a],l=r[s.id];l.needsUpdate!==!1&&s.setValue(e,l.value,n)}}static seqWithValue(e,t){const r=[];for(let n=0,a=e.length;n!==a;++n){const o=e[n];o.id in t&&r.push(o)}return r}}function gl(i,e,t){const r=i.createShader(e);return i.shaderSource(r,t),i.compileShader(r),r}const rm=37297;let im=0;function nm(i,e){const t=i.split(`
`),r=[],n=Math.max(e-6,0),a=Math.min(e+6,t.length);for(let o=n;o<a;o++){const s=o+1;r.push(`${s===e?">":" "} ${s}: ${t[o]}`)}return r.join(`
`)}function am(i){const e=Ye.getPrimaries(Ye.workingColorSpace),t=Ye.getPrimaries(i);let r;switch(e===t?r="":e===cn&&t===ln?r="LinearDisplayP3ToLinearSRGB":e===ln&&t===cn&&(r="LinearSRGBToLinearDisplayP3"),i){case Ft:case sn:return[r,"LinearTransferOETF"];case ut:case Ea:return[r,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[r,"LinearTransferOETF"]}}function _l(i,e,t){const r=i.getShaderParameter(e,i.COMPILE_STATUS),n=i.getShaderInfoLog(e).trim();if(r&&n==="")return"";const a=/ERROR: 0:(\d+)/.exec(n);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+n+`

`+nm(i.getShaderSource(e),o)}else return n}function sm(i,e){const t=am(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function om(i,e){let t;switch(e){case au:t="Linear";break;case su:t="Reinhard";break;case ou:t="OptimizedCineon";break;case lu:t="ACESFilmic";break;case uu:t="AgX";break;case cu:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function lm(i){return[i.extensionDerivatives||i.envMapCubeUVHeight||i.bumpMap||i.normalMapTangentSpace||i.clearcoatNormalMap||i.flatShading||i.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(i.extensionFragDepth||i.logarithmicDepthBuffer)&&i.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",i.extensionDrawBuffers&&i.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(i.extensionShaderTextureLOD||i.envMap||i.transmission)&&i.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(Ai).join(`
`)}function cm(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(Ai).join(`
`)}function um(i){const e=[];for(const t in i){const r=i[t];r!==!1&&e.push("#define "+t+" "+r)}return e.join(`
`)}function hm(i,e){const t={},r=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let n=0;n<r;n++){const a=i.getActiveAttrib(e,n),o=a.name;let s=1;a.type===i.FLOAT_MAT2&&(s=2),a.type===i.FLOAT_MAT3&&(s=3),a.type===i.FLOAT_MAT4&&(s=4),t[o]={type:a.type,location:i.getAttribLocation(e,o),locationSize:s}}return t}function Ai(i){return i!==""}function vl(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function xl(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const dm=/^[ \t]*#include +<([\w\d./]+)>/gm;function es(i){return i.replace(dm,fm)}const pm=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function fm(i,e){let t=Oe[e];if(t===void 0){const r=pm.get(e);if(r!==void 0)t=Oe[r],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,r);else throw new Error("Can not resolve #include <"+e+">")}return es(t)}const mm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function yl(i){return i.replace(mm,gm)}function gm(i,e,t,r){let n="";for(let a=parseInt(e);a<parseInt(t);a++)n+=r.replace(/\[\s*i\s*\]/g,"[ "+a+" ]").replace(/UNROLLED_LOOP_INDEX/g,a);return n}function bl(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function _m(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Ls?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Dc?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===ar&&(e="SHADOWMAP_TYPE_VSM"),e}function vm(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ti:case ri:e="ENVMAP_TYPE_CUBE";break;case an:e="ENVMAP_TYPE_CUBE_UV";break}return e}function xm(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ri:e="ENVMAP_MODE_REFRACTION";break}return e}function ym(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case ua:e="ENVMAP_BLENDING_MULTIPLY";break;case iu:e="ENVMAP_BLENDING_MIX";break;case nu:e="ENVMAP_BLENDING_ADD";break}return e}function bm(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:r,maxMip:t}}function Em(i,e,t,r){const n=i.getContext(),a=t.defines;let o=t.vertexShader,s=t.fragmentShader;const l=_m(t),c=vm(t),u=xm(t),f=ym(t),d=bm(t),p=t.isWebGL2?"":lm(t),g=cm(t),v=um(a),m=n.createProgram();let h,S,x=t.glslVersion?"#version "+t.glslVersion+`
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
		...
		void main() {
			...
			gl_FragColor = opacity * texel;
				...
				}`,blending:oa,depthTest:!1,depthWrite:!1,transparent:!0})}}Lr.BlurDirectionX=new be(1,0),Lr.BlurDirectionY=new be(0,1);class pg extends Yi{constructor(e,t,r=null,n=null,a=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=r,this.clearColor=n,this.clearAlpha=a,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new Ae}render(e,t,r){const n=e.autoClear;e.autoClear=!1;let a,o;this.overrideMaterial!==null&&(o=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor)),this.clearAlpha!==null&&(a=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:r),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(a),this.overrideMaterial!==null&&(this.scene.overrideMaterial=o),e.autoClear=n}}const pr=new Km,Ki=new Ri,Pr=new Ri;pr.add(Ki),Ki.add(Pr);const fr=new zt(45,window.innerWidth/window.innerHeight,1,1e4);fr.position.set(1500,1e3,1500),fr.lookAt(500,0,500),Ye.enabled=!0;const Zi=new wl({antialias:!0,canvas:Ci});Zi.setSize(window.innerWidth,window.innerHeight),Zi.setPixelRatio(Math.min(window.devicePixelRatio,2));const Vn=new dg(Zi),fg=new pg(pr,fr);Vn.addPass(fg);const Kr=new Lr(new be(window.innerWidth,window.innerHeight),pr,fr,[]);Kr.selectedObjects=[],Kr.edgeStrength=10,Kr.edgeThickness=1,Kr.visibleEdgeColor=new Ae(0,0,0),Vn.addPass(Kr);class mg{constructor(){this._previousTime=0,this._currentTime=0,this._startTime=os(),this._delta=0,this._elapsed=0,this._timescale=1,this._usePageVisibilityAPI=typeof document<"u"&&document.hidden!==void 0,this._usePageVisibilityAPI===!0&&(this._pageVisibilityHandler=gg.bind(this),document.addEventListener("visibilitychange",this._pageVisibilityHandler,!1))}getDelta(){return this._delta/1e3}getElapsed(){return this._elapsed/1e3}getTimescale(){return this._timescale}setTimescale(e){return this._timescale=e,this}reset(){return this._currentTime=os()-this._startTime,this}dispose(){return this._usePageVisibilityAPI===!0&&document.removeEventListener("visibilitychange",this._pageVisibilityHandler),this}update(e){return this._previousTime=this._currentTime,this._currentTime=(e!==void 0?e:os())-this._startTime,this._delta=(this._currentTime-this._previousTime)*this._timescale,this._elapsed+=this._delta,this}}function os(){return(typeof performance>"u"?Date:performance).now()}function gg(){document.hidden===!1&&this.reset()}const ls=new sg(fr,Ci);ls.target.set(500,0,500),ls.enableDamping=!0,new mg;let Xl=performance.now();const jl=()=>{const i=performance.now(),e=(i-Xl)/1e3;Xl=i,Vn.render(),ls.update(e),requestAnimationFrame(jl)},_g=new ng,cs=new ig(1e5,2e3);cs.raycast=()=>{},cs.position.set(500,0,500);const ql=document.getElementById("voxelColor");function vg(i,e){return Math.abs(i.r-e.r)<=Number.EPSILON&&Math.abs(i.g-e.g)<=Number.EPSILON&&Math.abs(i.b-e.b)<=Number.EPSILON}function Li(){const i=ql.value,e=parseInt(i.substring(1,3),16),t=parseInt(i.substring(3,5),16),r=parseInt(i.substring(5,7),16);return{r:e,g:t,b:r}}function Pi(i){let e=i>>16&255,t=i>>8&255,r=i&255,n=new Ae;return n.setRGB(e/255,t/255,r/255,Ft),{r:n.r*255,g:n.g*255,b:n.b*255}}function Yl(i){const{r:e,g:t,b:r}=i;let n=new Ae;n.setRGB(e/255,t/255,r/255,Ft);let a=Math.floor(n.r*255),o=Math.floor(n.g*255),s=Math.floor(n.b*255);return a<<16|o<<8|s}function mr(i){const{r:e,g:t,b:r}=i;return new Ae().setRGB(e/255,t/255,r/255,ut)}function xg(i){let e={r:0,g:0,b:0};return i.getRGB(e,Ft),{r:e.r*255,g:e.g*255,b:e.b*255}}function yg(i){ql.value="#"+i.toString(16)}new Xr(50,50,50);const Kl=new Xr(50,50,50);let Zl=new dr({color:mr(Li())});const gr=new Dt(Kl,Zl);gr.raycast=()=>{};const Jl=new Dt(Kl,Zl),Ql=new On(1e5,1e5);Ql.rotateX(-Math.PI/2);const Ui=new Dt(Ql,new ka({visible:!1}));Ui.position.set(500,0,500);const bg="/assets/voxel_bg-lwayk0Uo.wasm",Eg=async(i={},e)=>{let t;if(e.startsWith("data:")){const r=e.replace(/^data:.*?base64,/,"");let n;if(typeof Buffer=="function"&&typeof Buffer.from=="function")n=Buffer.from(r,"base64");else if(typeof atob=="function"){const a=atob(r);n=new Uint8Array(a.length);for(let o=0;o<a.length;o++)n[o]=a.charCodeAt(o)}else throw new Error("Cannot decode base64-encoded data URL");t=await WebAssembly.instantiate(n,i)}else{const r=await fetch(e),n=r.headers.get("Content-Type")||"";if("instantiateStreaming"in WebAssembly&&n.startsWith("application/wasm"))t=await WebAssembly.instantiateStreaming(r,i);else{const a=await r.arrayBuffer();t=await WebAssembly.instantiate(a,i)}}return t.instance.exports};let Y;function Mg(i){Y=i}let Wn=null;function Di(){return(Wn===null||Wn.byteLength===0)&&(Wn=new Uint8Array(Y.memory.buffer)),Wn}function us(i,e){return i=i>>>0,Di().subarray(i/1,i/1+e)}function ir(i){const e=Y.__externref_table_alloc();return Y.__wbindgen_export_2.set(e,i),e}function $l(i,e){try{return i.apply(this,e)}catch(t){const r=ir(t);Y.__wbindgen_exn_store(r)}}function $t(i){return i==null}const Sg=typeof TextDecoder>"u"?(0,module.require)("util").TextDecoder:TextDecoder;let ec=new Sg("utf-8",{ignoreBOM:!0,fatal:!0});ec.decode();function Zr(i,e){return i=i>>>0,ec.decode(Di().subarray(i,i+e))}let vt=0;const Tg=typeof TextEncoder>"u"?(0,module.require)("util").TextEncoder:TextEncoder;let Xn=new Tg("utf-8");const wg=typeof Xn.encodeInto=="function"?function(i,e){return Xn.encodeInto(i,e)}:function(i,e){const t=Xn.encode(i);return e.set(t),{read:i.length,written:t.length}};function Ii(i,e,t){if(t===void 0){const s=Xn.encode(i),l=e(s.length,1)>>>0;return Di().subarray(l,l+s.length).set(s),vt=s.length,l}let r=i.length,n=e(r,1)>>>0;const a=Di();let o=0;for(;o<r;o++){const s=i.charCodeAt(o);if(s>127)break;a[n+o]=s}if(o!==r){o!==0&&(i=i.slice(o)),n=t(n,r,r=o+i.length*3,1)>>>0;const s=Di().subarray(n+o,n+r),l=wg(i,s);o+=l.written,n=t(n,r,o,1)>>>0}return vt=o,n}let Ni=null;function _r(){return(Ni===null||Ni.buffer.detached===!0||Ni.buffer.detached===void 0&&Ni.buffer!==Y.memory.buffer)&&(Ni=new DataView(Y.memory.buffer)),Ni}let jn=null;function tc(){return(jn===null||jn.byteLength===0)&&(jn=new Float32Array(Y.memory.buffer)),jn}function qn(i,e){return i=i>>>0,tc().subarray(i/4,i/4+e)}function hs(i){const e=typeof i;if(e=="number"||e=="boolean"||i==null)return`${i}`;if(e=="string")return`"${i}"`;if(e=="symbol"){const n=i.description;return n==null?"Symbol":`Symbol(${n})`}if(e=="function"){const n=i.name;return typeof n=="string"&&n.length>0?`Function(${n})`:"Function"}if(Array.isArray(i)){const n=i.length;let a="[";n>0&&(a+=hs(i[0]));for(let o=1;o<n;o++)a+=", "+hs(i[o]);return a+="]",a}const t=/\[object ([^\]]+)\]/.exec(toString.call(i));let r;if(t&&t.length>1)r=t[1];else return toString.call(i);if(r=="Object")try{return"Object("+JSON.stringify(i)+")"}catch{return"Object"}return i instanceof Error?`${i.name}: ${i.message}
${i.stack}`:r}function ds(i,e){if(!(i instanceof e))throw new Error(`expected instance of ${e.name}`)}function Ag(i,e){const t=Ii(i,Y.__wbindgen_malloc,Y.__wbindgen_realloc),r=vt;ds(e,Zn);const n=Y.exportGeometryToZip(t,r,e.__wbg_ptr);var a=us(n[0],n[1]).slice();return Y.__wbindgen_free(n[0],n[1]*1,1),a}function rc(i){const e=Y.__wbindgen_export_2.get(i);return Y.__externref_table_dealloc(i),e}function ic(i){let e,t;try{ds(i,Oi);const a=Y.saveToString(i.__wbg_ptr);var r=a[0],n=a[1];if(a[3])throw r=0,n=0,rc(a[2]);return e=r,t=n,Zr(r,n)}finally{Y.__wbindgen_free(e,t,1)}}function nc(i){const e=Ii(i,Y.__wbindgen_malloc,Y.__wbindgen_realloc),t=vt,r=Y.loadFromString(e,t);if(r[2])throw rc(r[1]);return Oi.__wrap(r[0])}function ps(i,e){const t=e(i.length*4,4)>>>0;return tc().set(i,t/4),vt=i.length,t}let Yn=null;function Rg(){return(Yn===null||Yn.byteLength===0)&&(Yn=new Int32Array(Y.memory.buffer)),Yn}function Cg(i,e){return i=i>>>0,Rg().subarray(i/4,i/4+e)}let Kn=null;function Lg(){return(Kn===null||Kn.byteLength===0)&&(Kn=new Uint32Array(Y.memory.buffer)),Kn}function Pg(i,e){const t=e(i.length*4,4)>>>0;return Lg().set(i,t/4),vt=i.length,t}function Ug(i,e){const t=e(i.length*1,1)>>>0;return Di().set(i,t/1),vt=i.length,t}function Dg(i,e){i=i>>>0;const t=_r(),r=[];for(let n=i;n<i+4*e;n+=4)r.push(Y.__wbindgen_export_2.get(t.getUint32(n,!0)));return Y.__externref_drop_slice(i,e),r}function Ig(){Y.setup()}typeof FinalizationRegistry>"u"||new FinalizationRegistry(i=>Y.__wbg_basicshader_free(i>>>0,1)),typeof FinalizationRegistry>"u"||new FinalizationRegistry(i=>Y.__wbg_camera_free(i>>>0,1)),typeof FinalizationRegistry>"u"||new FinalizationRegistry(i=>Y.__wbg_cube_free(i>>>0,1));const ac=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(i=>Y.__wbg_geometry_free(i>>>0,1));class Zn{static __wrap(e){e=e>>>0;const t=Object.create(Zn.prototype);return t.__wbg_ptr=e,ac.register(t,t.__wbg_ptr,t),t}__destroy_into_raw(){const e=this.__wbg_ptr;return this.__wbg_ptr=0,ac.unregister(this),e}free(){const e=this.__destroy_into_raw();Y.__wbg_geometry_free(e,0)}get vertices(){const e=Y.__wbg_get_geometry_vertices(this.__wbg_ptr);var t=qn(e[0],e[1]).slice();return Y.__wbindgen_free(e[0],e[1]*4,4),t}set vertices(e){const t=ps(e,Y.__wbindgen_malloc),r=vt;Y.__wbg_set_geometry_vertices(this.__wbg_ptr,t,r)}get indices(){const e=Y.__wbg_get_geometry_indices(this.__wbg_ptr);var t=Cg(e[0],e[1]).slice();return Y.__wbindgen_free(e[0],e[1]*4,4),t}set indices(e){const t=Pg(e,Y.__wbindgen_malloc),r=vt;Y.__wbg_set_geometry_indices(this.__wbg_ptr,t,r)}get normals(){const e=Y.__wbg_get_geometry_normals(this.__wbg_ptr);var t=qn(e[0],e[1]).slice();return Y.__wbindgen_free(e[0],e[1]*4,4),t}set normals(e){const t=ps(e,Y.__wbindgen_malloc),r=vt;Y.__wbg_set_geometry_normals(this.__wbg_ptr,t,r)}get uvs(){const e=Y.__wbg_get_geometry_uvs(this.__wbg_ptr);var t=qn(e[0],e[1]).slice();return Y.__wbindgen_free(e[0],e[1]*4,4),t}set uvs(e){const t=ps(e,Y.__wbindgen_malloc),r=vt;Y.__wbg_set_geometry_uvs(this.__wbg_ptr,t,r)}get color_data(){const e=Y.__wbg_get_geometry_color_data(this.__wbg_ptr);var t=us(e[0],e[1]).slice();return Y.__wbindgen_free(e[0],e[1]*1,1),t}set color_data(e){const t=Ug(e,Y.__wbindgen_malloc),r=vt;Y.__wbg_set_geometry_color_data(this.__wbg_ptr,t,r)}}typeof FinalizationRegistry>"u"||new FinalizationRegistry(i=>Y.__wbg_mesh_free(i>>>0,1)),typeof FinalizationRegistry>"u"||new FinalizationRegistry(i=>Y.__wbg_mouseevent_free(i>>>0,1)),typeof FinalizationRegistry>"u"||new FinalizationRegistry(i=>Y.__wbg_palette_free(i>>>0,1)),typeof FinalizationRegistry>"u"||new FinalizationRegistry(i=>Y.__wbg_scene_free(i>>>0,1));const sc=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(i=>Y.__wbg_voxel_free(i>>>0,1));class Ji{static __wrap(e){e=e>>>0;const t=Object.create(Ji.prototype);return t.__wbg_ptr=e,sc.register(t,t.__wbg_ptr,t),t}__destroy_into_raw(){const e=this.__wbg_ptr;return this.__wbg_ptr=0,sc.unregister(this),e}free(){const e=this.__destroy_into_raw();Y.__wbg_voxel_free(e,0)}get x(){return Y.__wbg_get_voxel_x(this.__wbg_ptr)>>>0}set x(e){Y.__wbg_set_voxel_x(this.__wbg_ptr,e)}get y(){return Y.__wbg_get_voxel_y(this.__wbg_ptr)>>>0}set y(e){Y.__wbg_set_voxel_y(this.__wbg_ptr,e)}get z(){return Y.__wbg_get_voxel_z(this.__wbg_ptr)>>>0}set z(e){Y.__wbg_set_voxel_z(this.__wbg_ptr,e)}}const fs=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(i=>Y.__wbg_voxelmap_free(i>>>0,1));class Oi{static __wrap(e){e=e>>>0;const t=Object.create(Oi.prototype);return t.__wbg_ptr=e,fs.register(t,t.__wbg_ptr,t),t}__destroy_into_raw(){const e=this.__wbg_ptr;return this.__wbg_ptr=0,fs.unregister(this),e}free(){const e=this.__destroy_into_raw();Y.__wbg_voxelmap_free(e,0)}get width(){return Y.__wbg_get_voxelmap_width(this.__wbg_ptr)>>>0}set width(e){Y.__wbg_set_voxelmap_width(this.__wbg_ptr,e)}get height(){return Y.__wbg_get_voxelmap_height(this.__wbg_ptr)>>>0}set height(e){Y.__wbg_set_voxelmap_height(this.__wbg_ptr,e)}get depth(){return Y.__wbg_get_voxelmap_depth(this.__wbg_ptr)>>>0}set depth(e){Y.__wbg_set_voxelmap_depth(this.__wbg_ptr,e)}get undoStatusCallback(){return Y.__wbg_get_voxelmap_undoStatusCallback(this.__wbg_ptr)}set undoStatusCallback(e){Y.__wbg_set_voxelmap_undoStatusCallback(this.__wbg_ptr,$t(e)?0:ir(e))}get removeVoxelCallback(){return Y.__wbg_get_voxelmap_removeVoxelCallback(this.__wbg_ptr)}set removeVoxelCallback(e){Y.__wbg_set_voxelmap_removeVoxelCallback(this.__wbg_ptr,$t(e)?0:ir(e))}get setVoxelCallback(){return Y.__wbg_get_voxelmap_setVoxelCallback(this.__wbg_ptr)}set setVoxelCallback(e){Y.__wbg_set_voxelmap_setVoxelCallback(this.__wbg_ptr,$t(e)?0:ir(e))}get paletteColorSwapCallback(){return Y.__wbg_get_voxelmap_paletteColorSwapCallback(this.__wbg_ptr)}set paletteColorSwapCallback(e){Y.__wbg_set_voxelmap_paletteColorSwapCallback(this.__wbg_ptr,$t(e)?0:ir(e))}constructor(e,t,r){const n=Y.voxelmap_create_voxel_map(e,t,r);return this.__wbg_ptr=n>>>0,fs.register(this,this.__wbg_ptr,this),this}getVoxels(){const e=Y.voxelmap_getVoxels(this.__wbg_ptr);var t=Dg(e[0],e[1]).slice();return Y.__wbindgen_free(e[0],e[1]*4,4),t}getVoxelColor(e){ds(e,Ji);var t=e.__destroy_into_raw();const r=Y.voxelmap_getVoxelColor(this.__wbg_ptr,t);return r===4294967297?void 0:r}changeColor(e,t){Y.voxelmap_changeColor(this.__wbg_ptr,e,t)}getVoxel(e,t,r){const n=Y.voxelmap_getVoxel(this.__wbg_ptr,e,t,r);return n===0?void 0:Ji.__wrap(n)}generate_mesh(e,t,r){const n=Y.voxelmap_generate_mesh(this.__wbg_ptr,e,t,r);return Zn.__wrap(n)}paintVoxel(e,t,r,n){Y.voxelmap_paintVoxel(this.__wbg_ptr,e,t,r,n)}paintFlood(e,t,r,n){Y.voxelmap_paintFlood(this.__wbg_ptr,e,t,r,n)}setVoxel(e,t,r,n){Y.voxelmap_setVoxel(this.__wbg_ptr,e,t,r,n)}removeVoxel(e,t,r){Y.voxelmap_removeVoxel(this.__wbg_ptr,e,t,r)}undo(){Y.voxelmap_undo(this.__wbg_ptr)}redo(){Y.voxelmap_redo(this.__wbg_ptr)}}function Ng(i,e,t){i.attachShader(e,t)}function Og(i,e,t){i.bindBuffer(e>>>0,t)}function Fg(i,e){i.bindVertexArray(e)}function Bg(i,e,t,r,n){i.bufferData(e>>>0,us(t,r),n>>>0)}function zg(){return $l(function(i,e,t,r){return i.call(e,t,r)},arguments)}function Hg(){return $l(function(i,e,t,r,n){return i.call(e,t,r,n)},arguments)}function kg(i,e,t,r,n){i.clearColor(e,t,r,n)}function Gg(i,e){i.clear(e>>>0)}function Vg(i,e){i.compileShader(e)}function Wg(i){const e=i.createBuffer();return $t(e)?0:ir(e)}function Xg(i){const e=i.createProgram();return $t(e)?0:ir(e)}function jg(i,e){const t=i.createShader(e>>>0);return $t(t)?0:ir(t)}function qg(i){const e=i.createVertexArray();return $t(e)?0:ir(e)}function Yg(i,e,t,r,n){i.drawElements(e>>>0,t,r>>>0,n)}function Kg(i,e){i.enableVertexAttribArray(e>>>0)}function Zg(i,e){i.enable(e>>>0)}function Jg(i,e){let t,r;try{t=i,r=e,console.error(Zr(i,e))}finally{Y.__wbindgen_free(t,r,1)}}function Qg(i,e,t){const r=e.getProgramInfoLog(t);var n=$t(r)?0:Ii(r,Y.__wbindgen_malloc,Y.__wbindgen_realloc),a=vt;_r().setInt32(i+4,a,!0),_r().setInt32(i+0,n,!0)}function $g(i,e,t){return i.getProgramParameter(e,t>>>0)}function e_(i,e,t){const r=e.getShaderInfoLog(t);var n=$t(r)?0:Ii(r,Y.__wbindgen_malloc,Y.__wbindgen_realloc),a=vt;_r().setInt32(i+4,a,!0),_r().setInt32(i+0,n,!0)}function t_(i,e,t){return i.getShaderParameter(e,t>>>0)}function r_(i,e,t,r){const n=i.getUniformLocation(e,Zr(t,r));return $t(n)?0:ir(n)}function i_(i,e){i.linkProgram(e)}function n_(i,e){console.log(Zr(i,e))}function a_(){return new Array}function s_(){return new Error}function o_(i,e){return i.push(e)}function l_(i,e,t,r){i.shaderSource(e,Zr(t,r))}function c_(i,e){const t=e.stack,r=Ii(t,Y.__wbindgen_malloc,Y.__wbindgen_realloc),n=vt;_r().setInt32(i+4,n,!0),_r().setInt32(i+0,r,!0)}function u_(i,e,t,r,n){i.uniform3f(e,t,r,n)}function h_(i,e,t,r,n){i.uniformMatrix4fv(e,t!==0,qn(r,n))}function d_(i,e){i.useProgram(e)}function p_(i,e,t,r,n,a,o){i.vertexAttribPointer(e>>>0,t,r>>>0,n!==0,a,o)}function f_(i){return Ji.__wrap(i)}function m_(i){const e=i;return typeof e=="boolean"?e?1:0:2}function g_(i,e){const t=hs(e),r=Ii(t,Y.__wbindgen_malloc,Y.__wbindgen_realloc),n=vt;_r().setInt32(i+4,n,!0),_r().setInt32(i+0,r,!0)}function __(){const i=Y.__wbindgen_export_2,e=i.grow(4);i.set(0,void 0),i.set(e+0,void 0),i.set(e+1,null),i.set(e+2,!0),i.set(e+3,!1)}function v_(i){return i}function x_(i,e){return Zr(i,e)}function y_(i,e){throw new Error(Zr(i,e))}URL=globalThis.URL;const le=await Eg({"./voxel_bg.js":{__wbindgen_number_new:v_,__wbg_voxel_new:f_,__wbindgen_boolean_get:m_,__wbg_log_eb255972e71130b4:n_,__wbindgen_string_new:x_,__wbg_new_8a6f238a6ece86ea:s_,__wbg_stack_0ed75d68575b0f3c:c_,__wbg_error_7534b8e9a36f1ab4:Jg,__wbg_bindVertexArray_67a807a1cd64976a:Fg,__wbg_bufferData_049295bf6c0e35af:Bg,__wbg_createVertexArray_68ae270682fc14aa:qg,__wbg_uniformMatrix4fv_fa5c91b7cee9bfd5:h_,__wbg_attachShader_9b79a4896fee779d:Ng,__wbg_bindBuffer_e9412cc77f8130d6:Og,__wbg_clear_c182acb53176ea8b:Gg,__wbg_clearColor_7e5806f100e4cd7a:kg,__wbg_compileShader_fab2df50ae89c5e1:Vg,__wbg_createBuffer_8692729b8ac9caaf:Wg,__wbg_createProgram_b8f69529220fb50b:Xg,__wbg_createShader_809bd3abe629ad7a:jg,__wbg_drawElements_28e4f5037fe8c665:Yg,__wbg_enable_a7767e03f7973ca8:Zg,__wbg_enableVertexAttribArray_211547224fc25327:Kg,__wbg_getProgramInfoLog_760af7d6753bc699:Qg,__wbg_getProgramParameter_8a6b724d42d813b3:$g,__wbg_getShaderInfoLog_da62e75d61fbf8a8:e_,__wbg_getShaderParameter_f9c66f7ac8114c69:t_,__wbg_getUniformLocation_b9be4fbca76ab9a4:r_,__wbg_linkProgram_bcf6286423b25b5c:i_,__wbg_shaderSource_3bbf44221529c149:l_,__wbg_uniform3f_97385279cd44963d:u_,__wbg_useProgram_1a5a4be134db012a:d_,__wbg_vertexAttribPointer_1f280ac2d8994592:p_,__wbg_new_254fa9eac11932ae:a_,__wbg_push_6edad0df4b546b2c:o_,__wbg_call_3b770f0d6eb4720e:zg,__wbg_call_9bd6f269d4835e33:Hg,__wbindgen_debug_string:g_,__wbindgen_throw:y_,__wbindgen_init_externref_table:__}},bg),b_=le.memory,E_=le.exportJpeg,M_=le.exportGeometryToZip,S_=le.exportPng,T_=le.__wbg_mouseevent_free,w_=le.mouseevent_create,A_=le.__wbg_scene_free,R_=le.scene_create,C_=le.scene_update,L_=le.scene_mouseMove,P_=le.scene_click,U_=le.__wbg_mesh_free,D_=le.__wbg_cube_free,I_=le.cube_create,N_=le.__wbg_basicshader_free,O_=le.basicshader_create,F_=le.__wbg_camera_free,B_=le.camera_create_camera,z_=le.draw,H_=le.scene_mouseUp,k_=le.scene_mouseDown,G_=le.saveToString,V_=le.loadFromString,W_=le.__wbg_geometry_free,X_=le.__wbg_get_geometry_vertices,j_=le.__wbg_set_geometry_vertices,q_=le.__wbg_get_geometry_indices,Y_=le.__wbg_set_geometry_indices,K_=le.__wbg_get_geometry_normals,Z_=le.__wbg_set_geometry_normals,J_=le.__wbg_get_geometry_uvs,Q_=le.__wbg_set_geometry_uvs,$_=le.__wbg_get_geometry_color_data,ev=le.__wbg_set_geometry_color_data,tv=le.__wbg_voxel_free,rv=le.__wbg_get_voxel_x,iv=le.__wbg_set_voxel_x,nv=le.__wbg_get_voxel_y,av=le.__wbg_set_voxel_y,sv=le.__wbg_get_voxel_z,ov=le.__wbg_set_voxel_z,lv=le.__wbg_palette_free,cv=le.__wbg_voxelmap_free,uv=le.__wbg_get_voxelmap_width,hv=le.__wbg_set_voxelmap_width,dv=le.__wbg_get_voxelmap_height,pv=le.__wbg_set_voxelmap_height,fv=le.__wbg_get_voxelmap_depth,mv=le.__wbg_set_voxelmap_depth,gv=le.__wbg_get_voxelmap_undoStatusCallback,_v=le.__wbg_set_voxelmap_undoStatusCallback,vv=le.__wbg_get_voxelmap_removeVoxelCallback,xv=le.__wbg_set_voxelmap_removeVoxelCallback,yv=le.__wbg_get_voxelmap_setVoxelCallback,bv=le.__wbg_set_voxelmap_setVoxelCallback,Ev=le.__wbg_get_voxelmap_paletteColorSwapCallback,Mv=le.__wbg_set_voxelmap_paletteColorSwapCallback,Sv=le.voxelmap_create_voxel_map,Tv=le.voxelmap_getVoxels,wv=le.voxelmap_getVoxelColor,Av=le.voxelmap_changeColor,Rv=le.voxelmap_getVoxel,Cv=le.voxelmap_generate_mesh,Lv=le.voxelmap_paintVoxel,Pv=le.voxelmap_paintFlood,Uv=le.voxelmap_setVoxel,Dv=le.voxelmap_removeVoxel,Iv=le.voxelmap_undo,Nv=le.voxelmap_redo,Ov=le.setup,Fv=le.__wbindgen_exn_store,Bv=le.__externref_table_alloc,zv=le.__wbindgen_export_2,Hv=le.__wbindgen_free,kv=le.__wbindgen_malloc,Gv=le.__wbindgen_realloc,Vv=le.__externref_table_dealloc,Wv=le.__externref_drop_slice,oc=le.__wbindgen_start,Xv=Object.freeze(Object.defineProperty({__proto__:null,__externref_drop_slice:Wv,__externref_table_alloc:Bv,__externref_table_dealloc:Vv,__wbg_basicshader_free:N_,__wbg_camera_free:F_,__wbg_cube_free:D_,__wbg_geometry_free:W_,__wbg_get_geometry_color_data:$_,__wbg_get_geometry_indices:q_,__wbg_get_geometry_normals:K_,__wbg_get_geometry_uvs:J_,__wbg_get_geometry_vertices:X_,__wbg_get_voxel_x:rv,__wbg_get_voxel_y:nv,__wbg_get_voxel_z:sv,__wbg_get_voxelmap_depth:fv,__wbg_get_voxelmap_height:dv,__wbg_get_voxelmap_paletteColorSwapCallback:Ev,__wbg_get_voxelmap_removeVoxelCallback:vv,__wbg_get_voxelmap_setVoxelCallback:yv,__wbg_get_voxelmap_undoStatusCallback:gv,__wbg_get_voxelmap_width:uv,__wbg_mesh_free:U_,__wbg_mouseevent_free:T_,__wbg_palette_free:lv,__wbg_scene_free:A_,__wbg_set_geometry_color_data:ev,__wbg_set_geometry_indices:Y_,__wbg_set_geometry_normals:Z_,__wbg_set_geometry_uvs:Q_,__wbg_set_geometry_vertices:j_,__wbg_set_voxel_x:iv,__wbg_set_voxel_y:av,__wbg_set_voxel_z:ov,__wbg_set_voxelmap_depth:mv,__wbg_set_voxelmap_height:pv,__wbg_set_voxelmap_paletteColorSwapCallback:Mv,__wbg_set_voxelmap_removeVoxelCallback:xv,__wbg_set_voxelmap_setVoxelCallback:bv,__wbg_set_voxelmap_undoStatusCallback:_v,__wbg_set_voxelmap_width:hv,__wbg_voxel_free:tv,__wbg_voxelmap_free:cv,__wbindgen_exn_store:Fv,__wbindgen_export_2:zv,__wbindgen_free:Hv,__wbindgen_malloc:kv,__wbindgen_realloc:Gv,__wbindgen_start:oc,basicshader_create:O_,camera_create_camera:B_,cube_create:I_,draw:z_,exportGeometryToZip:M_,exportJpeg:E_,exportPng:S_,loadFromString:V_,memory:b_,mouseevent_create:w_,saveToString:G_,scene_click:P_,scene_create:R_,scene_mouseDown:k_,scene_mouseMove:L_,scene_mouseUp:H_,scene_update:C_,setup:Ov,voxelmap_changeColor:Av,voxelmap_create_voxel_map:Sv,voxelmap_generate_mesh:Cv,voxelmap_getVoxel:Rv,voxelmap_getVoxelColor:wv,voxelmap_getVoxels:Tv,voxelmap_paintFlood:Pv,voxelmap_paintVoxel:Lv,voxelmap_redo:Nv,voxelmap_removeVoxel:Dv,voxelmap_setVoxel:Uv,voxelmap_undo:Iv},Symbol.toStringTag,{value:"Module"}));Mg(Xv),oc();class jv{constructor(e){Nr(this,"value");Nr(this,"listeners",[]);this.value=e}listen(e){this.listeners.push(e);const t=this.listeners;return()=>{let r=t.indexOf(e);r!=-1&&t.splice(r,1)}}setValue(e){this.value=e,this.listeners.forEach(t=>{t(e)})}}const qv=document.getElementById("paint"),Yv=document.getElementById("place"),Kv=document.getElementById("delete"),Zv=document.getElementById("eyedropper");var er=(i=>(i[i.Place=0]="Place",i[i.Delete=1]="Delete",i[i.Paint=2]="Paint",i[i.Eyedropper=3]="Eyedropper",i))(er||{});let Ur=new jv(0);qv.addEventListener("click",()=>{Ur.setValue(2)}),Yv.addEventListener("click",()=>{Ur.setValue(0)}),Kv.addEventListener("click",()=>{Ur.setValue(1)}),Zv.addEventListener("click",()=>{Ur.setValue(3)});let lc=document.getElementById("toolLabel");var Jn;(i=>{i.autosave="voxel__autosave"})(Jn||(Jn={}));const Ht=1e7,cc=50;let rt=Jv();function ms(i,e,t){return new P(i,e,t).subScalar(Ht/2).multiplyScalar(cc).addScalar(25)}function Jv(){const i=localStorage.getItem(Jn.autosave);if(i){console.log("Loaded autosave!");const e=nc(i);return gs(e),e}else return new Oi(Ht,Ht,Ht)}function Qv(){let i=new Oi(Ht,Ht,Ht);gs(i),rt=i}function $v(i){gs(i),rt=i}function gs(i){Pr.clear();const e=i.getVoxels();for(const t of e){const r=t.x,n=t.y,a=t.z,o=ms(r,n,a),s=i.getVoxelColor(t),l=Jl.clone(!0);l.visible=!0;let c=mr(Pi(s));const u=new dr({color:c});l.material=u,l.position.copy(o),Pr.add(l)}}const e0="modulepreload",t0=function(i){return"/"+i},uc={},xt=function(i,e,t){let r=Promise.resolve();if(e&&e.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),o=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=Promise.allSettled(e.map(s=>{if(s=t0(s),s in uc)return;uc[s]=!0;const l=s.endsWith(".css"),c=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${s}"]${c}`))return;const u=document.createElement("link");if(u.rel=l?"stylesheet":e0,l||(u.as="script"),u.crossOrigin="",u.href=s,o&&u.setAttribute("nonce",o),document.head.appendChild(u),l)return new Promise((f,d)=>{u.addEventListener("load",f),u.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${s}`)))})}))}function n(a){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=a,window.dispatchEvent(o),!o.defaultPrevented)throw a}return r.then(a=>{for(const o of a||[])o.status==="rejected"&&n(o.reason);return i().catch(n)})},r0={accepts:[]},hc=globalThis.showOpenFilePicker;async function i0(i={}){const e={...r0,...i};if(hc&&!i._preferPolyfill)return hc(e);const t=document.createElement("input");t.type="file",t.multiple=e.multiple,t.accept=(e.accepts||[]).map(n=>[...(n.extensions||[]).map(a=>"."+a),...n.mimeTypes||[]]).flat().join(","),Object.assign(t.style,{position:"fixed",top:"-100000px",left:"-100000px"}),document.body.appendChild(t);const r=xt(()=>Promise.resolve().then(()=>o0),void 0);return await new Promise(n=>{t.addEventListener("change",n,{once:!0}),t.click()}),t.remove(),r.then(n=>n.getFileHandlesFromInput(t))}const dc=globalThis.showSaveFilePicker;async function pc(i={}){if(dc&&!i._preferPolyfill)return dc(i);i._name&&(console.warn("deprecated _name, spec now have `suggestedName`"),i.suggestedName=i._name);const{FileSystemFileHandle:e}=await xt(async()=>{const{FileSystemFileHandle:r}=await Promise.resolve().then(()=>Fi);return{FileSystemFileHandle:r}},void 0),{FileHandle:t}=await xt(async()=>{const{FileHandle:r}=await import("./downloader-BC5_xR1E.js").then(async n=>(await n.__tla,n));return{FileHandle:r}},[]);return new e(new t(i.suggestedName))}globalThis.DataTransferItem&&!DataTransferItem.prototype.getAsFileSystemHandle&&(DataTransferItem.prototype.getAsFileSystemHandle=async function(){const i=this.webkitGetAsEntry(),[{FileHandle:e,FolderHandle:t},{FileSystemDirectoryHandle:r},{FileSystemFileHandle:n}]=await Promise.all([xt(()=>import("./sandbox-BWD2aCOU.js").then(async a=>(await a.__tla,a)),[]),xt(()=>Promise.resolve().then(()=>vs),void 0),xt(()=>Promise.resolve().then(()=>Fi),void 0)]);return i.isFile?new n(new e(i,!1)):new r(new t(i,!1))});let fc;Rs={ReadableStream:globalThis.ReadableStream,WritableStream:globalThis.WritableStream,TransformStream:globalThis.TransformStream,DOMException:globalThis.DOMException,Blob:globalThis.Blob,File:globalThis.File},{WritableStream:fc}=Rs;const Es=class Es extends fc{constructor(t){super(t);Lc(this,ia);Pc(this,ia,t),Object.setPrototypeOf(this,Es.prototype),this._closed=!1}async close(){this._closed=!0;const t=this.getWriter(),r=t.close();return t.releaseLock(),r}seek(t){return this.write({type:"seek",position:t})}truncate(t){return this.write({type:"truncate",size:t})}write(t){if(this._closed)return Promise.reject(new TypeError("Cannot write to a CLOSED writable stream"));const r=this.getWriter(),n=r.write(t);return r.releaseLock(),n}};ia=new WeakMap;let Jr=Es;Object.defineProperty(Jr.prototype,Symbol.toStringTag,{value:"FileSystemWritableFileStream",writable:!1,enumerable:!1,configurable:!0}),Object.defineProperties(Jr.prototype,{close:{enumerable:!0},seek:{enumerable:!0},truncate:{enumerable:!0},write:{enumerable:!0}}),globalThis.FileSystemFileHandle&&!globalThis.FileSystemFileHandle.prototype.createWritable&&!globalThis.FileSystemWritableFileStream&&(globalThis.FileSystemWritableFileStream=Jr);const Dr=Symbol("adapter");vc=Dr;class _s{constructor(e){Nr(this,vc);Nr(this,"name");Nr(this,"kind");this.kind=e.kind,this.name=e.name,this[Dr]=e}async queryPermission(e={}){const{mode:t="read"}=e,r=this[Dr];if(r.queryPermission)return r.queryPermission({mode:t});if(t==="read")return"granted";if(t==="readwrite")return r.writable?"granted":"denied";throw new TypeError(`Mode ${t} must be 'read' or 'readwrite'`)}async requestPermission({mode:e="read"}={}){const t=this[Dr];if(t.requestPermission)return t.requestPermission({mode:e});if(e==="read")return"granted";if(e==="readwrite")return t.writable?"granted":"denied";throw new TypeError(`Mode ${e} must be 'read' or 'readwrite'`)}async remove(e={}){await this[Dr].remove(e)}async isSameEntry(e){return this===e?!0:!e||typeof e!="object"||this.kind!==e.kind||!e[Dr]?!1:this[Dr].isSameEntry(e[Dr])}}Object.defineProperty(_s.prototype,Symbol.toStringTag,{value:"FileSystemHandle",writable:!1,enumerable:!1,configurable:!0}),globalThis.FileSystemHandle&&((xc=globalThis.FileSystemHandle.prototype).queryPermission??(xc.queryPermission=function(i){return"granted"}));let mc;tn={INVALID:["seeking position failed.","InvalidStateError"],GONE:["A requested file or directory could not be found at the time an operation was processed.","NotFoundError"],MISMATCH:["The path supplied exists, but was not an entry of requested type.","TypeMismatchError"],MOD_ERR:["The object can not be modified in this way.","InvalidModificationError"],SYNTAX:i=>[`Failed to execute 'write' on 'UnderlyingSinkBase': Invalid params passed. ${i}`,"SyntaxError"],SECURITY:["It was determined that certain files are unsafe for access within a Web application, or that too many calls are being made on file resources.","SecurityError"],DISALLOWED:["The request is not allowed by the user agent or the platform in the current context.","NotAllowedError"]},mc={writable:globalThis.WritableStream};async function n0(i){console.warn("deprecated fromDataTransfer - use `dt.items[0].getAsFileSystemHandle()` instead");const[e,t,r]=await Promise.all([xt(()=>import("./memory-DEXhyNji.js").then(async a=>(await a.__tla,a)),[]),xt(()=>import("./sandbox-BWD2aCOU.js").then(async a=>(await a.__tla,a)),[]),xt(()=>Promise.resolve().then(()=>vs),void 0)]),n=new e.FolderHandle("",!1);return n._entries=i.map(a=>a.isFile?new t.FileHandle(a,!1):new t.FolderHandle(a,!1)),new r.FileSystemDirectoryHandle(n)}async function a0(i){const{FolderHandle:e,FileHandle:t}=await xt(async()=>{const{FolderHandle:s,FileHandle:l}=await import("./memory-DEXhyNji.js").then(async c=>(await c.__tla,c));return{FolderHandle:s,FileHandle:l}},[]),{FileSystemDirectoryHandle:r}=await xt(async()=>{const{FileSystemDirectoryHandle:s}=await Promise.resolve().then(()=>vs);return{FileSystemDirectoryHandle:s}},void 0),n=Array.from(i.files),a=n[0].webkitRelativePath.split("/",1)[0],o=new e(a,!1);return n.forEach(s=>{const l=s.webkitRelativePath.split("/");l.shift();const c=l.pop(),u=l.reduce((f,d)=>(f._entries[d]||(f._entries[d]=new e(d,!1)),f._entries[d]),o);u._entries[c]=new t(s.name,s,!1)}),new r(o)}async function s0(i){const{FileHandle:e}=await xt(async()=>{const{FileHandle:r}=await import("./memory-DEXhyNji.js").then(async n=>(await n.__tla,n));return{FileHandle:r}},[]),{FileSystemFileHandle:t}=await xt(async()=>{const{FileSystemFileHandle:r}=await Promise.resolve().then(()=>Fi);return{FileSystemFileHandle:r}},void 0);return Array.from(i.files).map(r=>new t(new e(r.name,r,!1)))}const o0=Object.freeze(Object.defineProperty({__proto__:null,config:mc,errors:tn,fromDataTransfer:n0,getDirHandlesFromInput:a0,getFileHandlesFromInput:s0},Symbol.toStringTag,{value:"Module"})),{GONE:l0,MOD_ERR:c0}=tn,Ir=Symbol("adapter");let Qn=class sa extends _s{constructor(t){super(t);Nr(this,yc);this[Ir]=t}async getDirectoryHandle(t,r={}){if(t==="")throw new TypeError("Name can't be an empty string.");if(t==="."||t===".."||t.includes("/"))throw new TypeError("Name contains invalid characters.");r.create=!!r.create;const n=await this[Ir].getDirectoryHandle(t,r);return new sa(n)}async*entries(){const{FileSystemFileHandle:t}=await xt(async()=>{const{FileSystemFileHandle:r}=await Promise.resolve().then(()=>Fi);return{FileSystemFileHandle:r}},void 0);for await(const[r,n]of this[Ir].entries())yield[n.name,n.kind==="file"?new t(n):new sa(n)]}async*getEntries(){const{FileSystemFileHandle:t}=await xt(async()=>{const{FileSystemFileHandle:r}=await Promise.resolve().then(()=>Fi);return{FileSystemFileHandle:r}},void 0);console.warn("deprecated, use .entries() instead");for await(let r of this[Ir].entries())yield r.kind==="file"?new t(r):new sa(r)}async getFileHandle(t,r={}){const{FileSystemFileHandle:n}=await xt(async()=>{const{FileSystemFileHandle:o}=await Promise.resolve().then(()=>Fi);return{FileSystemFileHandle:o}},void 0);if(t==="")throw new TypeError("Name can't be an empty string.");if(t==="."||t===".."||t.includes("/"))throw new TypeError("Name contains invalid characters.");r.create=!!r.create;const a=await this[Ir].getFileHandle(t,r);return new n(a)}async removeEntry(t,r={}){if(t==="")throw new TypeError("Name can't be an empty string.");if(t==="."||t===".."||t.includes("/"))throw new TypeError("Name contains invalid characters.");return r.recursive=!!r.recursive,this[Ir].removeEntry(t,r)}async resolve(t){if(await t.isSameEntry(this))return[];const r=[{handle:this,path:[]}];for(;r.length;){let{handle:n,path:a}=r.pop();for await(const o of n.values()){if(await o.isSameEntry(t))return[...a,o.name];o.kind==="directory"&&r.push({handle:o,path:[...a,o.name]})}}return null}async*keys(){for await(const[t]of this[Ir].entries())yield t}async*values(){for await(const[t,r]of this)yield r}[(yc=Ir,Symbol.asyncIterator)](){return this.entries()}};if(Object.defineProperty(Qn.prototype,Symbol.toStringTag,{value:"FileSystemDirectoryHandle",writable:!1,enumerable:!1,configurable:!0}),Object.defineProperties(Qn.prototype,{getDirectoryHandle:{enumerable:!0},entries:{enumerable:!0},getFileHandle:{enumerable:!0},removeEntry:{enumerable:!0}}),globalThis.FileSystemDirectoryHandle){const i=globalThis.FileSystemDirectoryHandle.prototype;i.resolve=async function(n){if(await n.isSameEntry(this))return[];const a=[{handle:this,path:[]}];for(;a.length;){let{handle:o,path:s}=a.pop();for await(const l of o.values()){if(await l.isSameEntry(n))return[...s,l.name];l.kind==="directory"&&a.push({handle:l,path:[...s,l.name]})}}return null};async function e(n){if(await(await navigator.storage.getDirectory()).resolve(n)===null)throw new DOMException(...l0)}const t=i.entries;i.entries=async function*(){await e(this),yield*t.call(this)},i[Symbol.asyncIterator]=async function*(){yield*this.entries()};const r=i.removeEntry;i.removeEntry=async function(n,a={}){return r.call(this,n,a).catch(async o=>{throw o instanceof DOMException&&o.name==="UnknownError"&&!a.recursive&&!(await t.call(this).next()).done?new DOMException(...c0):o})}}const vs=Object.freeze(Object.defineProperty({__proto__:null,FileSystemDirectoryHandle:Qn,default:Qn},Symbol.toStringTag,{value:"Module"})),{INVALID:u0,SYNTAX:xs,GONE:h0}=tn,$n=Symbol("adapter");class ea extends(Ec=_s,bc=$n,Ec){constructor(t){super(t);Nr(this,bc);this[$n]=t}async createWritable(t={}){return new Jr(await this[$n].createWritable(t))}async getFile(){return this[$n].getFile()}}if(Object.defineProperty(ea.prototype,Symbol.toStringTag,{value:"FileSystemFileHandle",writable:!1,enumerable:!1,configurable:!0}),Object.defineProperties(ea.prototype,{createWritable:{enumerable:!0},getFile:{enumerable:!0}}),globalThis.FileSystemFileHandle&&!globalThis.FileSystemFileHandle.prototype.createWritable){const i=new WeakMap;let e;const t=()=>{let n,a;onmessage=async o=>{const s=o.ports[0],l=o.data;switch(l.type){case"open":const c=l.name;let u=await navigator.storage.getDirectory();for(const f of l.path)u=await u.getDirectoryHandle(f);n=await u.getFileHandle(c),a=await n.createSyncAccessHandle();break;case"write":a.write(l.data,{at:l.position}),a.flush();break;case"truncate":a.truncate(l.size);break;case"abort":case"close":a.close();break}s.postMessage(0)}};globalThis.FileSystemFileHandle.prototype.createWritable=async function(n){if(!e){const p=`(${t.toString()})()`,g=new Blob([p],{type:"text/javascript"});e=URL.createObjectURL(g)}const a=new Worker(e,{type:"module"});let o=0;const s=new TextEncoder;let l=await this.getFile().then(p=>p.size);const c=p=>new Promise((g,v)=>{const m=new MessageChannel;m.port1.onmessage=h=>{h.data instanceof Error?v(h.data):g(h.data),m.port1.close(),m.port2.close(),m.port1.onmessage=null},a.postMessage(p,[m.port2])}),u=await navigator.storage.getDirectory(),f=await i.get(this),d=await u.resolve(f);if(d===null)throw new DOMException(...h0);return await c({type:"open",path:d,name:this.name}),(n==null?void 0:n.keepExistingData)===!1&&(await c({type:"truncate",size:0}),l=0),new Jr({start:p=>{},async write(p){if((p==null?void 0:p.constructor)===Object?p={...p}:p={type:"write",data:p,position:o},p.type==="write"){if(!("data"in p))throw await c({type:"close"}),new DOMException(...xs("write requires a data argument"));if(p.position??(p.position=o),typeof p.data=="string")p.data=s.encode(p.data);else if(p.data instanceof ArrayBuffer)p.data=new Uint8Array(p.data);else if(!(p.data instanceof Uint8Array)&&ArrayBuffer.isView(p.data))p.data=new Uint8Array(p.data.buffer,p.data.byteOffset,p.data.byteLength);else if(!(p.data instanceof Uint8Array)){const g=await new Response(p.data).arrayBuffer();p.data=new Uint8Array(g)}Number.isInteger(p.position)&&p.position>=0&&(o=p.position),o+=p.data.byteLength,l+=p.data.byteLength}else if(p.type==="seek")if(Number.isInteger(p.position)&&p.position>=0){if(l<p.position)throw new DOMException(...u0);console.log("seeking",p),o=p.position;return}else throw await c({type:"close"}),new DOMException(...xs("seek requires a position argument"));else if(p.type==="truncate")if(Number.isInteger(p.size)&&p.size>=0)l=p.size,o>l&&(o=l);else throw await c({type:"close"}),new DOMException(...xs("truncate requires a size argument"));await c(p)},async close(){await c({type:"close"}),a.terminate()},async abort(p){await c({type:"abort",reason:p}),a.terminate()}})};const r=FileSystemDirectoryHandle.prototype.getFileHandle;FileSystemDirectoryHandle.prototype.getFileHandle=async function(...n){const a=await r.call(this,...n);return i.set(a,this),a}}const Fi=Object.freeze(Object.defineProperty({__proto__:null,FileSystemFileHandle:ea,default:ea},Symbol.toStringTag,{value:"Module"})),d0=document.getElementById("newFile"),p0=document.getElementById("loadFile"),f0=document.getElementById("saveFile"),m0=document.getElementById("exportFile");let Qi="unnamed",g0=5*60*1e3;setInterval(()=>{console.log("Autosaving...");const i=ic(rt);localStorage.setItem(Jn.autosave,i),console.log("Autosaving complete!")},g0),d0.addEventListener("click",()=>{Qv()}),p0.addEventListener("click",async()=>{const[i]=await i0({accepts:[{accept:{"application/json":[".json"]}}],multiple:!1});Qi=i.name.split(".")[0];const e=await(await i.getFile()).text(),t=nc(e);$v(t)}),f0.addEventListener("click",async()=>{const i=await pc({suggestedName:`${Qi}.json`,types:[{accept:{"application/json":[".json"]}}]});Qi=i.name.split(".")[0];const e=ic(rt),t=await i.createWritable();await t.write(e),await t.close()}),m0.addEventListener("click",async()=>{const i=rt.generate_mesh(1,1024,50),e=Ag(Qi,i),t=await(await pc({suggestedName:`${Qi}.zip`,types:[{accept:{"application/zip":[".zip"]}}]})).createWritable();await t.write(e),await t.close()});const ys=document.getElementById("undoButton"),bs=document.getElementById("redoButton");ys.disabled=!0,bs.disabled=!0,rt.undoStatusCallback=(i,e)=>{ys.disabled=i,bs.disabled=e},ys.addEventListener("click",()=>{rt.undo()}),bs.addEventListener("click",()=>{rt.redo()});const _0=document.getElementById("swap");_0.onclick=()=>{rt.changeColor(12345678,0)},Ig();let ta=new rg,ra=new be;lc.innerText=`Current Tool: ${er[Ur.value]}`,Ur.listen(i=>{lc.innerText=`Current Tool: ${er[i]}`});function gc(i){const e=Ci.getBoundingClientRect();return{x:i.clientX-e.left,y:i.clientY-e.top}}function v0(){const i=new Jm(16777215,16777215,3);i.color.setRGB(.6,.6,.6),i.position.set(0,50,0),pr.add(i);const e=new eg(new Ae(1,1,1),6);e.position.set(-1,1.75,1),e.position.multiplyScalar(30),e.lookAt(new P(0,0,0)),pr.add(e),pr.add(_g),pr.add(cs),pr.background=new Ae(.95,.95,.95),pr.add(gr),Ki.add(Ui),document.addEventListener("pointermove",y0),document.addEventListener("pointerdown",b0),window.addEventListener("resize",x0),jl()}function x0(){fr.aspect=window.innerWidth/window.innerHeight,fr.updateProjectionMatrix(),Zi.setSize(window.innerWidth,window.innerHeight),Zi.setPixelRatio(Math.min(window.devicePixelRatio,2)),Vn.setSize(window.innerWidth,window.innerHeight)}function _c(i,e,t=1e-4){return Math.abs(i.x-e.x)<t&&Math.abs(i.y-e.y)<t&&Math.abs(i.z-e.z)<t}rt.removeVoxelCallback=(i,e,t)=>{let r=ms(i,e,t);for(const n of Pr.children)if(_c(n.position,r)){Pr.remove(n);break}},rt.setVoxelCallback=(i,e)=>{let[t,r,n]=i,a=ms(t,r,n);for(const c of Pr.children)if(_c(c.position,a)){let u=mr(Pi(e));const f=new dr({color:u});let d=c;d.material=f;return}const o=Jl.clone(!0);o.visible=!0;let s=mr(Pi(e));const l=new dr({color:s});o.material=l,o.position.copy(a),Pr.add(o)},rt.paletteColorSwapCallback=(i,e)=>{let t=Pi(i),r=Pi(e);for(const n of Pr.children)if(n instanceof Dt){const a=n.material,o=xg(a.color);vg(r,o)&&(a.color=mr(t))}};let $i=null;function y0(i){var r;if(i.target!==Ci)return;let e=gc(i);ra.set(e.x/window.innerWidth*2-1,-(e.y/window.innerHeight)*2+1),ta.setFromCamera(ra,fr);const t=ta.intersectObjects(Ki.children,!0);if(Kr.selectedObjects=[],$i){let n=$i.position.clone().divideScalar(50).floor();n.addScalar(Ht/2);let a=rt.getVoxel(n.x,n.y,n.z);if(a){const o=rt.getVoxelColor(a);let s=mr(Pi(o));const l=new dr({color:s});$i.material=l}$i=null}if(t.length>0){const n=t[0];switch(Ur.value){case er.Place:if(gr.material=new dr({color:mr(Li())}),gr.position.copy(n.point).add((r=n.face)==null?void 0:r.normal),gr.position.divideScalar(50).floor().multiplyScalar(50).addScalar(25),gr.position.y<0){gr.visible=!1;break}gr.visible=!0;break;case er.Paint:{let a=n.object;if(a!==Ui){const o=new dr({color:mr(Li())});a.material=o}break}case er.Delete:{let a=n.object;if(a!==Ui){const o=new dr({color:16711680});a.material=o}break}case er.Eyedropper:{let a=n.object;a!==Ui&&(Kr.selectedObjects=[a]);break}}n.object!==Ui&&($i=n.object)}else gr.visible=!1}function b0(i){var r;if(i.button!==0||i.target!==Ci)return;let e=gc(i);ra.set(e.x/window.innerWidth*2-1,-(e.y/window.innerHeight)*2+1),ta.setFromCamera(ra,fr);const t=ta.intersectObjects(Ki.children,!0);if(t.length>0){const n=t[0];switch(Ur.value){case er.Place:let a=n.point.add((r=n.face)==null?void 0:r.normal);if(a.divideScalar(cc).floor(),a.y<0)break;a.addScalar(Ht/2),rt.setVoxel(a.x,a.y,a.z,Yl(Li()));break;case er.Paint:{const o=n.object;let s=o.position.clone().divideScalar(50).floor();if(s.addScalar(Ht/2),rt.getVoxel(s.x,s.y,s.z)){rt.paintVoxel(s.x,s.y,s.z,Yl(Li()));const l=new dr({color:mr(Li())});o.material=l}break}case er.Delete:{const o=n.object;let s=o.position.clone().divideScalar(50).floor();s.addScalar(Ht/2),rt.getVoxel(s.x,s.y,s.z)&&(o.removeFromParent(),rt.removeVoxel(s.x,s.y,s.z));break}case er.Eyedropper:{let o=n.object.position.clone().divideScalar(50).floor();o.addScalar(Ht/2);let s=rt.getVoxel(o.x,o.y,o.z);if(s){let l=rt.getVoxelColor(s);yg(l)}break}}}}v0()})();export{L0 as __tla,Rs as c,tn as e};
