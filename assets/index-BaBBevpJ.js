...
#endif`,bh="gl_FragColor = linearToOutputTexel( gl_FragColor );",yh=`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Gt,depthTest:!1,depthWrite:!1})}function Zo(){return new Rt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:qa(),fragmentShader:`
		...
		`,blending:Gt,depthTest:!1,depthWrite:!1})}function Jo(){return new Rt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:qa(),fragmentShader:`
	...
	`}function Pp(i){let e=new WeakMap,t=null;function r(s){if(s&&s.isTexture){const l=s.mapping,c=l===aa||l===sa,u=l===ei||l===ti;if(c||u)if(s.isRenderTargetTexture&&s.needsPMREMUpdate===!0){s.needsPMREMUpdate=!1;let m=e.get(s);return t===null&&(t=new Yo(i)),m=c?t.fromEquirectangular(s,m):t.fromCubemap(s,m),e.set(s,m),m.texture}else{if(e.has(s))return e.get(s).texture;{const m=s.image;if(c&&m&&m.height>0||u&&m&&n(m)){t===null&&(t=new Yo(i));const d=c?t.fromEquirectangular(s):t.fromCubemap(s);return e.set(s,d),s.addEventListener("dispose",a),d.texture}else return null}}}return s}function n(s){let l=0;const c=6;for(let u=0;u<c;u++)s[u]!==void 0&&l++;return l===c}function a(s){const l=s.target;l.removeEventListener("dispose",a);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:r,dispose:o}}function Up(i){const e={};function t(r){if(e[r]!==void 0)return e[r];let n;switch(r){case"WEBGL_depth_texture":n=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":n=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":n=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":n=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:n=i.getExtension(r)}return e[r]=n,n}return{has:function(r){return t(r)!==null},init:function(r){r.isWebGL2?(t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance")):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(r){const n=t(r);return n===null&&console.warn("THREE.WebGLRenderer: "+r+" extension not supported."),n}}}function Dp(i,e,t,r){const n={},a=new WeakMap;function o(m){const d=m.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);for(const g in d.morphAttributes){const v=d.morphAttributes[g];for(let f=0,h=v.length;f<h;f++)e.remove(v[f])}d.removeEventListener("dispose",o),delete n[d.id];const p=a.get(d);p&&(e.remove(p),a.delete(d)),r.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function s(m,d){return n[d.id]===!0||(d.addEventListener("dispose",o),n[d.id]=!0,t.memory.geometries++),d}function l(m){const d=m.attributes;for(const g in d)e.update(d[g],i.ARRAY_BUFFER);const p=m.morphAttributes;for(const g in p){const v=p[g];for(let f=0,h=v.length;f<h;f++)e.update(v[f],i.ARRAY_BUFFER)}}function c(m){const d=[],p=m.index,g=m.attributes.position;let v=0;if(p!==null){const T=p.array;v=p.version;for(let x=0,C=T.length;x<C;x+=3){const D=T[x+0],R=T[x+1],A=T[x+2];d.push(D,R,R,A,A,D)}}else if(g!==void 0){const T=g.array;v=g.version;for(let x=0,C=T.length/3-1;x<C;x+=3){const D=x+0,R=x+1,A=x+2;d.push(D,R,R,A,A,D)}}else return;const f=new(vo(d)?No:Io)(d,1);f.version=v;const h=a.get(m);h&&e.remove(h),a.set(m,f)}function u(m){const d=a.get(m);if(d){const p=m.index;p!==null&&d.version<p.version&&c(m)}else c(m);return a.get(m)}return{get:s,update:l,getWireframeAttribute:u}}function Ip(i,e,t,r){const n=r.isWebGL2;let a;function o(p){a=p}let s,l;function c(p){s=p.type,l=p.bytesPerElement}function u(p,g){i.drawElements(a,g,s,p*l),t.update(g,a,1)}function m(p,g,v){if(v===0)return;let f,h;if(n)f=i,h="drawElementsInstanced";else if(f=e.get("ANGLE_instanced_arrays"),h="drawElementsInstancedANGLE",f===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}f[h](a,g,s,p*l,v),t.update(g,a,v)}function d(p,g,v){if(v===0)return;const f=e.get("WEBGL_multi_draw");if(f===null)for(let h=0;h<v;h++)this.render(p[h]/l,g[h]);else{f.multiDrawElementsWEBGL(a,g,0,s,p,0,v);let h=0;for(let T=0;T<v;T++)h+=g[T];t.update(h,a,1)}}this.setMode=o,this.setIndex=c,this.render=u,this.renderInstances=m,this.renderMultiDraw=d}function Np(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function r(a,o,s){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=s*(a/3);break;case i.LINES:t.lines+=s*(a/2);break;case i.LINE_STRIP:t.lines+=s*(a-1);break;case i.LINE_LOOP:t.lines+=s*a;break;case i.POINTS:t.points+=s*a;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function n(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:n,update:r}}function Op(i,e){return i[0]-e[0]}function Fp(i,e){return Math.abs(e[1])-Math.abs(i[1])}function Bp(i,e,t){const r={},n=new Float32Array(8),a=new WeakMap,o=new lt,s=[];for(let c=0;c<8;c++)s[c]=[c,0];function l(c,u,m){const d=c.morphTargetInfluences;if(e.isWebGL2===!0){const p=u.morphAttributes.position||u.morphAttributes.normal||u.morphAttributes.color,g=p!==void 0?p.length:0;let v=a.get(u);if(v===void 0||v.count!==g){let T=function(){le.dispose(),a.delete(u),u.removeEventListener("dispose",T)};v!==void 0&&v.texture.dispose();const x=u.morphAttributes.position!==void 0,C=u.morphAttributes.normal!==void 0,D=u.morphAttributes.color!==void 0,R=u.morphAttributes.position||[],A=u.morphAttributes.normal||[],K=u.morphAttributes.color||[];let y=0;x===!0&&(y=1),C===!0&&(y=2),D===!0&&(y=3);let E=u.attributes.position.count*y,k=1;E>e.maxTextureSize&&(k=Math.ceil(E/e.maxTextureSize),E=e.maxTextureSize);const G=new Float32Array(E*k*4*g),le=new Eo(G,E,k,g);le.type=br,le.needsUpdate=!0;const L=y*4;for(let z=0;z<g;z++){const V=R[z],j=A[z],X=K[z],W=E*k*4*z;for(let J=0;J<V.count;J++){const re=J*L;x===!0&&(o.fromBufferAttribute(V,J),G[W+re+0]=o.x,G[W+re+1]=o.y,G[W+re+2]=o.z,G[W+re+3]=0),C===!0&&(o.fromBufferAttribute(j,J),G[W+re+4]=o.x,G[W+re+5]=o.y,G[W+re+6]=o.z,G[W+re+7]=0),D===!0&&(o.fromBufferAttribute(X,J),G[W+re+8]=o.x,G[W+re+9]=o.y,G[W+re+10]=o.z,G[W+re+11]=X.itemSize===4?o.w:1)}}v={count:g,texture:le,size:new Me(E,k)},a.set(u,v),u.addEventListener("dispose",T)}let f=0;for(let T=0;T<d.length;T++)f+=d[T];const h=u.morphTargetsRelative?1:1-f;m.getUniforms().setValue(i,"morphTargetBaseInfluence",h),m.getUniforms().setValue(i,"morphTargetInfluences",d),m.getUniforms().setValue(i,"morphTargetsTexture",v.texture,t),m.getUniforms().setValue(i,"morphTargetsTextureSize",v.size)}else{const p=d===void 0?0:d.length;let g=r[u.id];if(g===void 0||g.length!==p){g=[];for(let x=0;x<p;x++)g[x]=[x,0];r[u.id]=g}for(let x=0;x<p;x++){const C=g[x];C[0]=x,C[1]=d[x]}g.sort(Fp);for(let x=0;x<8;x++)x<p&&g[x][1]?(s[x][0]=g[x][0],s[x][1]=g[x][1]):(s[x][0]=Number.MAX_SAFE_INTEGER,s[x][1]=0);s.sort(Op);const v=u.morphAttributes.position,f=u.morphAttributes.normal;let h=0;for(let x=0;x<8;x++){const C=s[x],D=C[0],R=C[1];D!==Number.MAX_SAFE_INTEGER&&R?(v&&u.getAttribute("morphTarget"+x)!==v[D]&&u.setAttribute("morphTarget"+x,v[D]),f&&u.getAttribute("morphNormal"+x)!==f[D]&&u.setAttribute("morphNormal"+x,f[D]),n[x]=R,h+=R):(v&&u.hasAttribute("morphTarget"+x)===!0&&u.deleteAttribute("morphTarget"+x),f&&u.hasAttribute("morphNormal"+x)===!0&&u.deleteAttribute("morphNormal"+x),n[x]=0)}const T=u.morphTargetsRelative?1:1-h;m.getUniforms().setValue(i,"morphTargetBaseInfluence",T),m.getUniforms().setValue(i,"morphTargetInfluences",n)}}return{update:l}}function zp(i,e,t,r){let n=new WeakMap;function a(l){const c=r.render.frame,u=l.geometry,m=e.get(l,u);if(n.get(m)!==c&&(e.update(m),n.set(m,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",s)===!1&&l.addEventListener("dispose",s),n.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),n.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;n.get(d)!==c&&(d.update(),n.set(d,c))}return m}function o(){n=new WeakMap}function s(l){const c=l.target;c.removeEventListener("dispose",s),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:a,dispose:o}}class Qo extends Ct{constructor(e,t,r,n,a,o,s,l,c,u){if(u=u!==void 0?u:Ir,u!==Ir&&u!==ri)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");r===void 0&&u===Ir&&(r=xr),r===void 0&&u===ri&&(r=Dr),super(null,n,a,o,s,l,u,r,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=s!==void 0?s:xt,this.minFilter=l!==void 0?l:xt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const $o=new Ct,el=new Qo(1,1);el.compareFunction=fo;const tl=new Eo,rl=new Eu,il=new Vo,nl=[],al=[],sl=new Float32Array(16),ol=new Float32Array(9),ll=new Float32Array(4);function Si(i,e,t){const r=i[0];if(r<=0||r>0)return i;const n=e*t;let a=nl[n];if(a===void 0&&(a=new Float32Array(n),nl[n]=a),e!==0){r.toArray(a,0);for(let o=1,s=0;o!==e;++o)s+=t,i[o].toArray(a,s)}return a}function nt(i,e){if(i.length!==e.length)return!1;for(let t=0,r=i.length;t<r;t++)if(i[t]!==e[t])return!1;return!0}function at(i,e){for(let t=0,r=e.length;t<r;t++)i[t]=e[t]}function Un(i,e){let t=al[e];t===void 0&&(t=new Int32Array(e),al[e]=t);for(let r=0;r!==e;++r)t[r]=i.allocateTextureUnit();return t}function Hp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function kp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(nt(t,e))return;i.uniform2fv(this.addr,e),at(t,e)}}function Gp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(nt(t,e))return;i.uniform3fv(this.addr,e),at(t,e)}}function Vp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(nt(t,e))return;i.uniform4fv(this.addr,e),at(t,e)}}function Wp(i,e){const t=this.cache,r=e.elements;if(r===void 0){if(nt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),at(t,e)}else{if(nt(t,r))return;ll.set(r),i.uniformMatrix2fv(this.addr,!1,ll),at(t,r)}}function Xp(i,e){const t=this.cache,r=e.elements;if(r===void 0){if(nt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),at(t,e)}else{if(nt(t,r))return;ol.set(r),i.uniformMatrix3fv(this.addr,!1,ol),at(t,r)}}function jp(i,e){const t=this.cache,r=e.elements;if(r===void 0){if(nt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),at(t,e)}else{if(nt(t,r))return;sl.set(r),i.uniformMatrix4fv(this.addr,!1,sl),at(t,r)}}function qp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Yp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(nt(t,e))return;i.uniform2iv(this.addr,e),at(t,e)}}function Kp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(nt(t,e))return;i.uniform3iv(this.addr,e),at(t,e)}}function Zp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(nt(t,e))return;i.uniform4iv(this.addr,e),at(t,e)}}function Jp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Qp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(nt(t,e))return;i.uniform2uiv(this.addr,e),at(t,e)}}function $p(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(nt(t,e))return;i.uniform3uiv(this.addr,e),at(t,e)}}function ef(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(nt(t,e))return;i.uniform4uiv(this.addr,e),at(t,e)}}function tf(i,e,t){const r=this.cache,n=t.allocateTextureUnit();r[0]!==n&&(i.uniform1i(this.addr,n),r[0]=n);const a=this.type===i.SAMPLER_2D_SHADOW?el:$o;t.setTexture2D(e||a,n)}function rf(i,e,t){const r=this.cache,n=t.allocateTextureUnit();r[0]!==n&&(i.uniform1i(this.addr,n),r[0]=n),t.setTexture3D(e||rl,n)}function nf(i,e,t){const r=this.cache,n=t.allocateTextureUnit();r[0]!==n&&(i.uniform1i(this.addr,n),r[0]=n),t.setTextureCube(e||il,n)}function af(i,e,t){const r=this.cache,n=t.allocateTextureUnit();r[0]!==n&&(i.uniform1i(this.addr,n),r[0]=n),t.setTexture2DArray(e||tl,n)}function sf(i){switch(i){case 5126:return Hp;case 35664:return kp;case 35665:return Gp;case 35666:return Vp;case 35674:return Wp;case 35675:return Xp;case 35676:return jp;case 5124:case 35670:return qp;case 35667:case 35671:return Yp;case 35668:case 35672:return Kp;case 35669:case 35673:return Zp;case 5125:return Jp;case 36294:return Qp;case 36295:return $p;case 36296:return ef;case 35678:case 36198:case 36298:case 36306:case 35682:return tf;case 35679:case 36299:case 36307:return rf;case 35680:case 36300:case 36308:case 36293:return nf;case 36289:case 36303:case 36311:case 36292:return af}}function of(i,e){i.uniform1fv(this.addr,e)}function lf(i,e){const t=Si(e,this.size,2);i.uniform2fv(this.addr,t)}function cf(i,e){const t=Si(e,this.size,3);i.uniform3fv(this.addr,t)}function uf(i,e){const t=Si(e,this.size,4);i.uniform4fv(this.addr,t)}function hf(i,e){const t=Si(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function df(i,e){const t=Si(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function pf(i,e){const t=Si(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function ff(i,e){i.uniform1iv(this.addr,e)}function mf(i,e){i.uniform2iv(this.addr,e)}function gf(i,e){i.uniform3iv(this.addr,e)}function _f(i,e){i.uniform4iv(this.addr,e)}function vf(i,e){i.uniform1uiv(this.addr,e)}function xf(i,e){i.uniform2uiv(this.addr,e)}function bf(i,e){i.uniform3uiv(this.addr,e)}function yf(i,e){i.uniform4uiv(this.addr,e)}function Mf(i,e,t){const r=this.cache,n=e.length,a=Un(t,n);nt(r,a)||(i.uniform1iv(this.addr,a),at(r,a));for(let o=0;o!==n;++o)t.setTexture2D(e[o]||$o,a[o])}function Sf(i,e,t){const r=this.cache,n=e.length,a=Un(t,n);nt(r,a)||(i.uniform1iv(this.addr,a),at(r,a));for(let o=0;o!==n;++o)t.setTexture3D(e[o]||rl,a[o])}function Ef(i,e,t){const r=this.cache,n=e.length,a=Un(t,n);nt(r,a)||(i.uniform1iv(this.addr,a),at(r,a));for(let o=0;o!==n;++o)t.setTextureCube(e[o]||il,a[o])}function Tf(i,e,t){const r=this.cache,n=e.length,a=Un(t,n);nt(r,a)||(i.uniform1iv(this.addr,a),at(r,a));for(let o=0;o!==n;++o)t.setTexture2DArray(e[o]||tl,a[o])}function wf(i){switch(i){case 5126:return of;case 35664:return lf;case 35665:return cf;case 35666:return uf;case 35674:return hf;case 35675:return df;case 35676:return pf;case 5124:case 35670:return ff;case 35667:case 35671:return mf;case 35668:case 35672:return gf;case 35669:case 35673:return _f;case 5125:return vf;case 36294:return xf;case 36295:return bf;case 36296:return yf;case 35678:case 36198:case 36298:case 36306:case 35682:return Mf;case 35679:case 36299:case 36307:return Sf;case 35680:case 36300:case 36308:case 36293:return Ef;case 36289:case 36303:case 36311:case 36292:return Tf}}class Af{constructor(e,t,r){this.id=e,this.addr=r,this.cache=[],this.type=t.type,this.setValue=sf(t.type)}}class Rf{constructor(e,t,r){this.id=e,this.addr=r,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=wf(t.type)}}class Cf{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,r){const n=this.seq;for(let a=0,o=n.length;a!==o;++a){const s=n[a];s.setValue(e,t[s.id],r)}}}const Ya=/(\w+)(\])?(\[|\.)?/g;function cl(i,e){i.seq.push(e),i.map[e.id]=e}function Lf(i,e,t){const r=i.name,n=r.length;for(Ya.lastIndex=0;;){const a=Ya.exec(r),o=Ya.lastIndex;let s=a[1];const l=a[2]==="]",c=a[3];if(l&&(s=s|0),c===void 0||c==="["&&o+2===n){cl(t,c===void 0?new Af(s,i,e):new Rf(s,i,e));break}else{let u=t.map[s];u===void 0&&(u=new Cf(s),cl(t,u)),t=u}}}class Dn{constructor(e,t){this.seq=[],this.map={};const r=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let n=0;n<r;++n){const a=e.getActiveUniform(t,n),o=e.getUniformLocation(t,a.name);Lf(a,o,this)}}setValue(e,t,r,n){const a=this.map[t];a!==void 0&&a.setValue(e,r,n)}setOptional(e,t,r){const n=t[r];n!==void 0&&this.setValue(e,r,n)}static upload(e,t,r,n){for(let a=0,o=t.length;a!==o;++a){const s=t[a],l=r[s.id];l.needsUpdate!==!1&&s.setValue(e,l.value,n)}}static seqWithValue(e,t){const r=[];for(let n=0,a=e.length;n!==a;++n){const o=e[n];o.id in t&&r.push(o)}return r}}function ul(i,e,t){const r=i.createShader(e);return i.shaderSource(r,t),i.compileShader(r),r}const Pf=37297;let Uf=0;function Df(i,e){const t=i.split(`
`),r=[],n=Math.max(e-6,0),a=Math.min(e+6,t.length);for(let o=n;o<a;o++){const s=o+1;r.push(`${s===e?">":" "} ${s}: ${t[o]}`)}return r.join(`
`)}function If(i){const e=Ze.getPrimaries(Ze.workingColorSpace),t=Ze.getPrimaries(i);let r;switch(e===t?r="":e===tn&&t===en?r="LinearDisplayP3ToLinearSRGB":e===en&&t===tn&&(r="LinearSRGBToLinearDisplayP3"),i){case Xt:case Qi:return[r,"LinearTransferOETF"];case ot:case ga:return[r,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[r,"LinearTransferOETF"]}}function hl(i,e,t){const r=i.getShaderParameter(e,i.COMPILE_STATUS),n=i.getShaderInfoLog(e).trim();if(r&&n==="")return"";const a=/ERROR: 0:(\d+)/.exec(n);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+n+`

`+Df(i.getShaderSource(e),o)}else return n}function Nf(i,e){const t=If(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function Of(i,e){let t;switch(e){case qc:t="Linear";break;case Yc:t="Reinhard";break;case Kc:t="OptimizedCineon";break;case Zc:t="ACESFilmic";break;case Qc:t="AgX";break;case Jc:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function Ff(i){return[i.extensionDerivatives||i.envMapCubeUVHeight||i.bumpMap||i.normalMapTangentSpace||i.clearcoatNormalMap||i.flatShading||i.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(i.extensionFragDepth||i.logarithmicDepthBuffer)&&i.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",i.extensionDrawBuffers&&i.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(i.extensionShaderTextureLOD||i.envMap||i.transmission)&&i.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(Ei).join(`
...
`)}function Hf(i,e){const t={},r=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let n=0;n<r;n++){const a=i.getActiveAttrib(e,n),o=a.name;let s=1;a.type===i.FLOAT_MAT2&&(s=2),a.type===i.FLOAT_MAT3&&(s=3),a.type===i.FLOAT_MAT4&&(s=4),t[o]={type:a.type,location:i.getAttribLocation(e,o),locationSize:s}}return t}function Ei(i){return i!==""}function dl(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function pl(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const kf=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ka(i){return i.replace(kf,Vf)}const Gf=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function Vf(i,e){let t=Be[e];if(t===void 0){const r=Gf.get(e);if(r!==void 0)t=Be[r],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,r);else throw new Error("Can not resolve #include <"+e+">")}return Ka(t)}const Wf=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function fl(i){return i.replace(Wf,Xf)}function Xf(i,e,t,r){let n="";for(let a=parseInt(e);a<parseInt(t);a++)n+=r.replace(/\[\s*i\s*\]/g,"[ "+a+" ]").replace(/UNROLLED_LOOP_INDEX/g,a);return n}function ml(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function jf(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Es?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===yc?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===tr&&(e="SHADOWMAP_TYPE_VSM"),e}function qf(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ei:case ti:e="ENVMAP_TYPE_CUBE";break;case Ji:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Yf(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ti:e="ENVMAP_MODE_REFRACTION";break}return e}function Kf(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case na:e="ENVMAP_BLENDING_MULTIPLY";break;case Xc:e="ENVMAP_BLENDING_MIX";break;case jc:e="ENVMAP_BLENDING_ADD";break}return e}function Zf(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:r,maxMip:t}}function Jf(i,e,t,r){const n=i.getContext(),a=t.defines;let o=t.vertexShader,s=t.fragmentShader;const l=jf(t),c=qf(t),u=Yf(t),m=Kf(t),d=Zf(t),p=t.isWebGL2?"":Ff(t),g=Bf(t),v=zf(a),f=n.createProgram();let h,T,x=t.glslVersion?"#version "+t.glslVersion+`
`:"";t.isRawShaderMaterial?(h=["#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,v].filter(Ei).join(`
`),h.length>0&&(h+=`
`),T=[p,"#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,v].filter(Ei).join(`
`),T.length>0&&(T+=`
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
		...
		void main() {
			...
			gl_FragColor = opacity * texel;
				...
				}`,blending:ta,depthTest:!1,depthWrite:!1,transparent:!0})}}Rr.BlurDirectionX=new Me(1,0),Rr.BlurDirectionY=new Me(0,1);class Wm extends ki{constructor(e,t,r=null,n=null,a=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=r,this.clearColor=n,this.clearAlpha=a,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new Re}render(e,t,r){const n=e.autoClear;e.autoClear=!1;let a,o;this.overrideMaterial!==null&&(o=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor)),this.clearAlpha!==null&&(a=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:r),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(a),this.overrideMaterial!==null&&(this.scene.overrideMaterial=o),e.autoClear=n}}const cr=new Em,Gi=new Ti,Xr=new Ti;cr.add(Gi),Gi.add(Xr);const ur=new Ft(45,window.innerWidth/window.innerHeight,1,1e4);ur.position.set(1500,1e3,1500),ur.lookAt(500,0,500),Ze.enabled=!0;const Vi=new bl({antialias:!0,canvas:Ar});Vi.setSize(window.innerWidth,window.innerHeight),Vi.setPixelRatio(Math.min(window.devicePixelRatio,2));const On=new Vm(Vi),Xm=new Wm(cr,ur);On.addPass(Xm);const jr=new Rr(new Me(window.innerWidth,window.innerHeight),cr,ur,[]);jr.selectedObjects=[],jr.edgeStrength=10,jr.edgeThickness=1,jr.visibleEdgeColor=new Re(0,0,0),On.addPass(jr);const is=new Nm(ur,Ar);is.target.set(500,0,500),is.enableDamping=!0,new Om;let zl=performance.now();const Hl=()=>{const i=performance.now(),e=(i-zl)/1e3;zl=i,On.render(),is.update(e),requestAnimationFrame(Hl)},jm=new Dm,ns=new Um(1e5,2e3);ns.raycast=()=>{},ns.position.set(500,0,500);const kl=document.getElementById("voxelColor");function wi(){const i=kl.value,e=parseInt(i.substring(1,3),16),t=parseInt(i.substring(3,5),16),r=parseInt(i.substring(5,7),16);return{r:e,g:t,b:r}}function Fn(i){let e=i>>16&255,t=i>>8&255,r=i&255,n=new Re;return n.setRGB(e/255,t/255,r/255,Xt),{r:n.r*255,g:n.g*255,b:n.b*255}}function Gl(i){const{r:e,g:t,b:r}=i;let n=new Re;n.setRGB(e/255,t/255,r/255,Xt);let a=Math.floor(n.r*255),o=Math.floor(n.g*255),s=Math.floor(n.b*255);return a<<16|o<<8|s}function Cr(i){const{r:e,g:t,b:r}=i;return new Re().setRGB(e/255,t/255,r/255,ot)}function qm(i){kl.value="#"+i.toString(16).padStart(6,"0")}new kr(50,50,50);const Vl=new kr(50,50,50);let Wl=new lr({color:Cr(wi())});const Bt=new Ot(Vl,Wl);Bt.raycast=()=>{};const Xl=new Ot(Vl,Wl),jl=new Cn(1e5,1e5);jl.rotateX(-Math.PI/2);const Ai=new Ot(jl,new Oa({visible:!1}));Ai.position.set(500,0,500);const Ym="/assets/voxel_bg-HmafTobH.wasm",Km=async(i={},e)=>{let t;if(e.startsWith("data:")){const r=e.replace(/^data:.*?base64,/,"");let n;if(typeof Buffer=="function"&&typeof Buffer.from=="function")n=Buffer.from(r,"base64");else if(typeof atob=="function"){const a=atob(r);n=new Uint8Array(a.length);for(let o=0;o<a.length;o++)n[o]=a.charCodeAt(o)}else throw new Error("Cannot decode base64-encoded data URL");t=await WebAssembly.instantiate(n,i)}else{const r=await fetch(e),n=r.headers.get("Content-Type")||"";if("instantiateStreaming"in WebAssembly&&n.startsWith("application/wasm"))t=await WebAssembly.instantiateStreaming(r,i);else{const a=await r.arrayBuffer();t=await WebAssembly.instantiate(a,i)}}return t.instance.exports};let q;function Zm(i){q=i}let Bn=null;function Ri(){return(Bn===null||Bn.byteLength===0)&&(Bn=new Uint8Array(q.memory.buffer)),Bn}function as(i,e){return i=i>>>0,Ri().subarray(i/1,i/1+e)}function hr(i){const e=q.__externref_table_alloc();return q.__wbindgen_export_2.set(e,i),e}function ql(i,e){try{return i.apply(this,e)}catch(t){const r=hr(t);q.__wbindgen_exn_store(r)}}function $t(i){return i==null}const Jm=typeof TextDecoder>"u"?(0,module.require)("util").TextDecoder:TextDecoder;let Yl=new Jm("utf-8",{ignoreBOM:!0,fatal:!0});Yl.decode();function qr(i,e){return i=i>>>0,Yl.decode(Ri().subarray(i,i+e))}let mt=0;const Qm=typeof TextEncoder>"u"?(0,module.require)("util").TextEncoder:TextEncoder;let zn=new Qm("utf-8");const $m=typeof zn.encodeInto=="function"?function(i,e){return zn.encodeInto(i,e)}:function(i,e){const t=zn.encode(i);return e.set(t),{read:i.length,written:t.length}};function Ci(i,e,t){if(t===void 0){const s=zn.encode(i),l=e(s.length,1)>>>0;return Ri().subarray(l,l+s.length).set(s),mt=s.length,l}let r=i.length,n=e(r,1)>>>0;const a=Ri();let o=0;for(;o<r;o++){const s=i.charCodeAt(o);if(s>127)break;a[n+o]=s}if(o!==r){o!==0&&(i=i.slice(o)),n=t(n,r,r=o+i.length*3,1)>>>0;const s=Ri().subarray(n+o,n+r),l=$m(i,s);o+=l.written,n=t(n,r,o,1)>>>0}return mt=o,n}let Li=null;function dr(){return(Li===null||Li.buffer.detached===!0||Li.buffer.detached===void 0&&Li.buffer!==q.memory.buffer)&&(Li=new DataView(q.memory.buffer)),Li}let Hn=null;function Kl(){return(Hn===null||Hn.byteLength===0)&&(Hn=new Float32Array(q.memory.buffer)),Hn}function kn(i,e){return i=i>>>0,Kl().subarray(i/4,i/4+e)}function ss(i){const e=typeof i;if(e=="number"||e=="boolean"||i==null)return`${i}`;if(e=="string")return`"${i}"`;if(e=="symbol"){const n=i.description;return n==null?"Symbol":`Symbol(${n})`}if(e=="function"){const n=i.name;return typeof n=="string"&&n.length>0?`Function(${n})`:"Function"}if(Array.isArray(i)){const n=i.length;let a="[";n>0&&(a+=ss(i[0]));for(let o=1;o<n;o++)a+=", "+ss(i[o]);return a+="]",a}const t=/\[object ([^\]]+)\]/.exec(toString.call(i));let r;if(t&&t.length>1)r=t[1];else return toString.call(i);if(r=="Object")try{return"Object("+JSON.stringify(i)+")"}catch{return"Object"}return i instanceof Error?`${i.name}: ${i.message}
${i.stack}`:r}function os(i,e){if(!(i instanceof e))throw new Error(`expected instance of ${e.name}`)}function eg(i,e){const t=Ci(i,q.__wbindgen_malloc,q.__wbindgen_realloc),r=mt;os(e,Wn);const n=q.exportGeometryToZip(t,r,e.__wbg_ptr);var a=as(n[0],n[1]).slice();return q.__wbindgen_free(n[0],n[1]*1,1),a}function Zl(i){const e=q.__wbindgen_export_2.get(i);return q.__externref_table_dealloc(i),e}function Jl(i){let e,t;try{os(i,Xi);const a=q.saveToString(i.__wbg_ptr);var r=a[0],n=a[1];if(a[3])throw r=0,n=0,Zl(a[2]);return e=r,t=n,qr(r,n)}finally{q.__wbindgen_free(e,t,1)}}function Ql(i){const e=Ci(i,q.__wbindgen_malloc,q.__wbindgen_realloc),t=mt,r=q.loadFromString(e,t);if(r[2])throw Zl(r[1]);return Xi.__wrap(r[0])}function ls(i,e){const t=e(i.length*4,4)>>>0;return Kl().set(i,t/4),mt=i.length,t}let Gn=null;function tg(){return(Gn===null||Gn.byteLength===0)&&(Gn=new Int32Array(q.memory.buffer)),Gn}function rg(i,e){return i=i>>>0,tg().subarray(i/4,i/4+e)}let Vn=null;function ig(){return(Vn===null||Vn.byteLength===0)&&(Vn=new Uint32Array(q.memory.buffer)),Vn}function ng(i,e){const t=e(i.length*4,4)>>>0;return ig().set(i,t/4),mt=i.length,t}function ag(i,e){const t=e(i.length*1,1)>>>0;return Ri().set(i,t/1),mt=i.length,t}function sg(i,e){i=i>>>0;const t=dr(),r=[];for(let n=i;n<i+4*e;n+=4)r.push(q.__wbindgen_export_2.get(t.getUint32(n,!0)));return q.__externref_drop_slice(i,e),r}function og(){q.setup()}typeof FinalizationRegistry>"u"||new FinalizationRegistry(i=>q.__wbg_basicshader_free(i>>>0,1)),typeof FinalizationRegistry>"u"||new FinalizationRegistry(i=>q.__wbg_camera_free(i>>>0,1)),typeof FinalizationRegistry>"u"||new FinalizationRegistry(i=>q.__wbg_cube_free(i>>>0,1));const $l=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(i=>q.__wbg_geometry_free(i>>>0,1));class Wn{static __wrap(e){e=e>>>0;const t=Object.create(Wn.prototype);return t.__wbg_ptr=e,$l.register(t,t.__wbg_ptr,t),t}__destroy_into_raw(){const e=this.__wbg_ptr;return this.__wbg_ptr=0,$l.unregister(this),e}free(){const e=this.__destroy_into_raw();q.__wbg_geometry_free(e,0)}get vertices(){const e=q.__wbg_get_geometry_vertices(this.__wbg_ptr);var t=kn(e[0],e[1]).slice();return q.__wbindgen_free(e[0],e[1]*4,4),t}set vertices(e){const t=ls(e,q.__wbindgen_malloc),r=mt;q.__wbg_set_geometry_vertices(this.__wbg_ptr,t,r)}get indices(){const e=q.__wbg_get_geometry_indices(this.__wbg_ptr);var t=rg(e[0],e[1]).slice();return q.__wbindgen_free(e[0],e[1]*4,4),t}set indices(e){const t=ng(e,q.__wbindgen_malloc),r=mt;q.__wbg_set_geometry_indices(this.__wbg_ptr,t,r)}get normals(){const e=q.__wbg_get_geometry_normals(this.__wbg_ptr);var t=kn(e[0],e[1]).slice();return q.__wbindgen_free(e[0],e[1]*4,4),t}set normals(e){const t=ls(e,q.__wbindgen_malloc),r=mt;q.__wbg_set_geometry_normals(this.__wbg_ptr,t,r)}get uvs(){const e=q.__wbg_get_geometry_uvs(this.__wbg_ptr);var t=kn(e[0],e[1]).slice();return q.__wbindgen_free(e[0],e[1]*4,4),t}set uvs(e){const t=ls(e,q.__wbindgen_malloc),r=mt;q.__wbg_set_geometry_uvs(this.__wbg_ptr,t,r)}get color_data(){const e=q.__wbg_get_geometry_color_data(this.__wbg_ptr);var t=as(e[0],e[1]).slice();return q.__wbindgen_free(e[0],e[1]*1,1),t}set color_data(e){const t=ag(e,q.__wbindgen_malloc),r=mt;q.__wbg_set_geometry_color_data(this.__wbg_ptr,t,r)}}typeof FinalizationRegistry>"u"||new FinalizationRegistry(i=>q.__wbg_mesh_free(i>>>0,1)),typeof FinalizationRegistry>"u"||new FinalizationRegistry(i=>q.__wbg_mouseevent_free(i>>>0,1)),typeof FinalizationRegistry>"u"||new FinalizationRegistry(i=>q.__wbg_palette_free(i>>>0,1)),typeof FinalizationRegistry>"u"||new FinalizationRegistry(i=>q.__wbg_scene_free(i>>>0,1));const ec=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(i=>q.__wbg_voxel_free(i>>>0,1));class Wi{static __wrap(e){e=e>>>0;const t=Object.create(Wi.prototype);return t.__wbg_ptr=e,ec.register(t,t.__wbg_ptr,t),t}__destroy_into_raw(){const e=this.__wbg_ptr;return this.__wbg_ptr=0,ec.unregister(this),e}free(){const e=this.__destroy_into_raw();q.__wbg_voxel_free(e,0)}get x(){return q.__wbg_get_voxel_x(this.__wbg_ptr)>>>0}set x(e){q.__wbg_set_voxel_x(this.__wbg_ptr,e)}get y(){return q.__wbg_get_voxel_y(this.__wbg_ptr)>>>0}set y(e){q.__wbg_set_voxel_y(this.__wbg_ptr,e)}get z(){return q.__wbg_get_voxel_z(this.__wbg_ptr)>>>0}set z(e){q.__wbg_set_voxel_z(this.__wbg_ptr,e)}}const cs=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(i=>q.__wbg_voxelmap_free(i>>>0,1));class Xi{static __wrap(e){e=e>>>0;const t=Object.create(Xi.prototype);return t.__wbg_ptr=e,cs.register(t,t.__wbg_ptr,t),t}__destroy_into_raw(){const e=this.__wbg_ptr;return this.__wbg_ptr=0,cs.unregister(this),e}free(){const e=this.__destroy_into_raw();q.__wbg_voxelmap_free(e,0)}get width(){return q.__wbg_get_voxelmap_width(this.__wbg_ptr)>>>0}set width(e){q.__wbg_set_voxelmap_width(this.__wbg_ptr,e)}get height(){return q.__wbg_get_voxelmap_height(this.__wbg_ptr)>>>0}set height(e){q.__wbg_set_voxelmap_height(this.__wbg_ptr,e)}get depth(){return q.__wbg_get_voxelmap_depth(this.__wbg_ptr)>>>0}set depth(e){q.__wbg_set_voxelmap_depth(this.__wbg_ptr,e)}get undoStatusCallback(){return q.__wbg_get_voxelmap_undoStatusCallback(this.__wbg_ptr)}set undoStatusCallback(e){q.__wbg_set_voxelmap_undoStatusCallback(this.__wbg_ptr,$t(e)?0:hr(e))}get removeVoxelCallback(){return q.__wbg_get_voxelmap_removeVoxelCallback(this.__wbg_ptr)}set removeVoxelCallback(e){q.__wbg_set_voxelmap_removeVoxelCallback(this.__wbg_ptr,$t(e)?0:hr(e))}get setVoxelCallback(){return q.__wbg_get_voxelmap_setVoxelCallback(this.__wbg_ptr)}set setVoxelCallback(e){q.__wbg_set_voxelmap_setVoxelCallback(this.__wbg_ptr,$t(e)?0:hr(e))}constructor(e,t,r){const n=q.voxelmap_create_voxel_map(e,t,r);return this.__wbg_ptr=n>>>0,cs.register(this,this.__wbg_ptr,this),this}clear(){q.voxelmap_clear(this.__wbg_ptr)}getVoxels(){const e=q.voxelmap_getVoxels(this.__wbg_ptr);var t=sg(e[0],e[1]).slice();return q.__wbindgen_free(e[0],e[1]*4,4),t}getVoxelColor(e){os(e,Wi);var t=e.__destroy_into_raw();const r=q.voxelmap_getVoxelColor(this.__wbg_ptr,t);return r===4294967297?void 0:r}getVoxel(e,t,r){const n=q.voxelmap_getVoxel(this.__wbg_ptr,e,t,r);return n===0?void 0:Wi.__wrap(n)}generate_mesh(e,t,r){const n=q.voxelmap_generate_mesh(this.__wbg_ptr,e,t,r);return Wn.__wrap(n)}paintVoxel(e,t,r,n){q.voxelmap_paintVoxel(this.__wbg_ptr,e,t,r,n)}paintFlood(e,t,r,n){q.voxelmap_paintFlood(this.__wbg_ptr,e,t,r,n)}setVoxel(e,t,r,n){q.voxelmap_setVoxel(this.__wbg_ptr,e,t,r,n)}removeVoxel(e,t,r){q.voxelmap_removeVoxel(this.__wbg_ptr,e,t,r)}undo(){q.voxelmap_undo(this.__wbg_ptr)}redo(){q.voxelmap_redo(this.__wbg_ptr)}}function lg(i,e,t){i.attachShader(e,t)}function cg(i,e,t){i.bindBuffer(e>>>0,t)}function ug(i,e){i.bindVertexArray(e)}function hg(i,e,t,r,n){i.bufferData(e>>>0,as(t,r),n>>>0)}function dg(){return ql(function(i,e,t,r){return i.call(e,t,r)},arguments)}function pg(){return ql(function(i,e,t,r,n){return i.call(e,t,r,n)},arguments)}function fg(i,e,t,r,n){i.clearColor(e,t,r,n)}function mg(i,e){i.clear(e>>>0)}function gg(i,e){i.compileShader(e)}function _g(i){const e=i.createBuffer();return $t(e)?0:hr(e)}function vg(i){const e=i.createProgram();return $t(e)?0:hr(e)}function xg(i,e){const t=i.createShader(e>>>0);return $t(t)?0:hr(t)}function bg(i){const e=i.createVertexArray();return $t(e)?0:hr(e)}function yg(i,e,t,r,n){i.drawElements(e>>>0,t,r>>>0,n)}function Mg(i,e){i.enableVertexAttribArray(e>>>0)}function Sg(i,e){i.enable(e>>>0)}function Eg(i,e){let t,r;try{t=i,r=e,console.error(qr(i,e))}finally{q.__wbindgen_free(t,r,1)}}function Tg(i,e,t){const r=e.getProgramInfoLog(t);var n=$t(r)?0:Ci(r,q.__wbindgen_malloc,q.__wbindgen_realloc),a=mt;dr().setInt32(i+4,a,!0),dr().setInt32(i+0,n,!0)}function wg(i,e,t){return i.getProgramParameter(e,t>>>0)}function Ag(i,e,t){const r=e.getShaderInfoLog(t);var n=$t(r)?0:Ci(r,q.__wbindgen_malloc,q.__wbindgen_realloc),a=mt;dr().setInt32(i+4,a,!0),dr().setInt32(i+0,n,!0)}function Rg(i,e,t){return i.getShaderParameter(e,t>>>0)}function Cg(i,e,t,r){const n=i.getUniformLocation(e,qr(t,r));return $t(n)?0:hr(n)}function Lg(i,e){i.linkProgram(e)}function Pg(i,e){console.log(qr(i,e))}function Ug(){return new Array}function Dg(){return new Error}function Ig(i,e){return i.push(e)}function Ng(i,e,t,r){i.shaderSource(e,qr(t,r))}function Og(i,e){const t=e.stack,r=Ci(t,q.__wbindgen_malloc,q.__wbindgen_realloc),n=mt;dr().setInt32(i+4,n,!0),dr().setInt32(i+0,r,!0)}function Fg(i,e,t,r,n){i.uniform3f(e,t,r,n)}function Bg(i,e,t,r,n){i.uniformMatrix4fv(e,t!==0,kn(r,n))}function zg(i,e){i.useProgram(e)}function Hg(i,e,t,r,n,a,o){i.vertexAttribPointer(e>>>0,t,r>>>0,n!==0,a,o)}function kg(i){return Wi.__wrap(i)}function Gg(i){const e=i;return typeof e=="boolean"?e?1:0:2}function Vg(i,e){const t=ss(e),r=Ci(t,q.__wbindgen_malloc,q.__wbindgen_realloc),n=mt;dr().setInt32(i+4,n,!0),dr().setInt32(i+0,r,!0)}function Wg(){const i=q.__wbindgen_export_2,e=i.grow(4);i.set(0,void 0),i.set(e+0,void 0),i.set(e+1,null),i.set(e+2,!0),i.set(e+3,!1)}function Xg(i){return i}function jg(i,e){return qr(i,e)}function qg(i,e){throw new Error(qr(i,e))}URL=globalThis.URL;const se=await Km({"./voxel_bg.js":{__wbindgen_number_new:Xg,__wbg_voxel_new:kg,__wbindgen_boolean_get:Gg,__wbg_log_eb255972e71130b4:Pg,__wbindgen_string_new:jg,__wbg_new_8a6f238a6ece86ea:Dg,__wbg_stack_0ed75d68575b0f3c:Og,__wbg_error_7534b8e9a36f1ab4:Eg,__wbg_bindVertexArray_67a807a1cd64976a:ug,__wbg_bufferData_049295bf6c0e35af:hg,__wbg_createVertexArray_68ae270682fc14aa:bg,__wbg_uniformMatrix4fv_fa5c91b7cee9bfd5:Bg,__wbg_attachShader_9b79a4896fee779d:lg,__wbg_bindBuffer_e9412cc77f8130d6:cg,__wbg_clear_c182acb53176ea8b:mg,__wbg_clearColor_7e5806f100e4cd7a:fg,__wbg_compileShader_fab2df50ae89c5e1:gg,__wbg_createBuffer_8692729b8ac9caaf:_g,__wbg_createProgram_b8f69529220fb50b:vg,__wbg_createShader_809bd3abe629ad7a:xg,__wbg_drawElements_28e4f5037fe8c665:yg,__wbg_enable_a7767e03f7973ca8:Sg,__wbg_enableVertexAttribArray_211547224fc25327:Mg,__wbg_getProgramInfoLog_760af7d6753bc699:Tg,__wbg_getProgramParameter_8a6b724d42d813b3:wg,__wbg_getShaderInfoLog_da62e75d61fbf8a8:Ag,__wbg_getShaderParameter_f9c66f7ac8114c69:Rg,__wbg_getUniformLocation_b9be4fbca76ab9a4:Cg,__wbg_linkProgram_bcf6286423b25b5c:Lg,__wbg_shaderSource_3bbf44221529c149:Ng,__wbg_uniform3f_97385279cd44963d:Fg,__wbg_useProgram_1a5a4be134db012a:zg,__wbg_vertexAttribPointer_1f280ac2d8994592:Hg,__wbg_new_254fa9eac11932ae:Ug,__wbg_push_6edad0df4b546b2c:Ig,__wbg_call_3b770f0d6eb4720e:dg,__wbg_call_9bd6f269d4835e33:pg,__wbindgen_debug_string:Vg,__wbindgen_throw:qg,__wbindgen_init_externref_table:Wg}},Ym),Yg=se.memory,Kg=se.exportJpeg,Zg=se.exportGeometryToZip,Jg=se.exportPng,Qg=se.__wbg_mouseevent_free,$g=se.mouseevent_create,e_=se.__wbg_scene_free,t_=se.scene_create,r_=se.scene_update,i_=se.scene_mouseMove,n_=se.scene_click,a_=se.__wbg_mesh_free,s_=se.__wbg_cube_free,o_=se.cube_create,l_=se.__wbg_basicshader_free,c_=se.basicshader_create,u_=se.__wbg_camera_free,h_=se.camera_create_camera,d_=se.draw,p_=se.scene_mouseUp,f_=se.scene_mouseDown,m_=se.saveToString,g_=se.loadFromString,__=se.__wbg_geometry_free,v_=se.__wbg_get_geometry_vertices,x_=se.__wbg_set_geometry_vertices,b_=se.__wbg_get_geometry_indices,y_=se.__wbg_set_geometry_indices,M_=se.__wbg_get_geometry_normals,S_=se.__wbg_set_geometry_normals,E_=se.__wbg_get_geometry_uvs,T_=se.__wbg_set_geometry_uvs,w_=se.__wbg_get_geometry_color_data,A_=se.__wbg_set_geometry_color_data,R_=se.__wbg_voxel_free,C_=se.__wbg_get_voxel_x,L_=se.__wbg_set_voxel_x,P_=se.__wbg_get_voxel_y,U_=se.__wbg_set_voxel_y,D_=se.__wbg_get_voxel_z,I_=se.__wbg_set_voxel_z,N_=se.__wbg_palette_free,O_=se.__wbg_voxelmap_free,F_=se.__wbg_get_voxelmap_width,B_=se.__wbg_set_voxelmap_width,z_=se.__wbg_get_voxelmap_height,H_=se.__wbg_set_voxelmap_height,k_=se.__wbg_get_voxelmap_depth,G_=se.__wbg_set_voxelmap_depth,V_=se.__wbg_get_voxelmap_undoStatusCallback,W_=se.__wbg_set_voxelmap_undoStatusCallback,X_=se.__wbg_get_voxelmap_removeVoxelCallback,j_=se.__wbg_set_voxelmap_removeVoxelCallback,q_=se.__wbg_get_voxelmap_setVoxelCallback,Y_=se.__wbg_set_voxelmap_setVoxelCallback,K_=se.voxelmap_create_voxel_map,Z_=se.voxelmap_clear,J_=se.voxelmap_getVoxels,Q_=se.voxelmap_getVoxelColor,$_=se.voxelmap_getVoxel,ev=se.voxelmap_generate_mesh,tv=se.voxelmap_paintVoxel,rv=se.voxelmap_paintFlood,iv=se.voxelmap_setVoxel,nv=se.voxelmap_removeVoxel,av=se.voxelmap_undo,sv=se.voxelmap_redo,ov=se.setup,lv=se.__wbindgen_exn_store,cv=se.__externref_table_alloc,uv=se.__wbindgen_export_2,hv=se.__wbindgen_free,dv=se.__wbindgen_malloc,pv=se.__wbindgen_realloc,fv=se.__externref_table_dealloc,mv=se.__externref_drop_slice,tc=se.__wbindgen_start,gv=Object.freeze(Object.defineProperty({__proto__:null,__externref_drop_slice:mv,__externref_table_alloc:cv,__externref_table_dealloc:fv,__wbg_basicshader_free:l_,__wbg_camera_free:u_,__wbg_cube_free:s_,__wbg_geometry_free:__,__wbg_get_geometry_color_data:w_,__wbg_get_geometry_indices:b_,__wbg_get_geometry_normals:M_,__wbg_get_geometry_uvs:E_,__wbg_get_geometry_vertices:v_,__wbg_get_voxel_x:C_,__wbg_get_voxel_y:P_,__wbg_get_voxel_z:D_,__wbg_get_voxelmap_depth:k_,__wbg_get_voxelmap_height:z_,__wbg_get_voxelmap_removeVoxelCallback:X_,__wbg_get_voxelmap_setVoxelCallback:q_,__wbg_get_voxelmap_undoStatusCallback:V_,__wbg_get_voxelmap_width:F_,__wbg_mesh_free:a_,__wbg_mouseevent_free:Qg,__wbg_palette_free:N_,__wbg_scene_free:e_,__wbg_set_geometry_color_data:A_,__wbg_set_geometry_indices:y_,__wbg_set_geometry_normals:S_,__wbg_set_geometry_uvs:T_,__wbg_set_geometry_vertices:x_,__wbg_set_voxel_x:L_,__wbg_set_voxel_y:U_,__wbg_set_voxel_z:I_,__wbg_set_voxelmap_depth:G_,__wbg_set_voxelmap_height:H_,__wbg_set_voxelmap_removeVoxelCallback:j_,__wbg_set_voxelmap_setVoxelCallback:Y_,__wbg_set_voxelmap_undoStatusCallback:W_,__wbg_set_voxelmap_width:B_,__wbg_voxel_free:R_,__wbg_voxelmap_free:O_,__wbindgen_exn_store:lv,__wbindgen_export_2:uv,__wbindgen_free:hv,__wbindgen_malloc:dv,__wbindgen_realloc:pv,__wbindgen_start:tc,basicshader_create:c_,camera_create_camera:h_,cube_create:o_,draw:d_,exportGeometryToZip:Zg,exportJpeg:Kg,exportPng:Jg,loadFromString:g_,memory:Yg,mouseevent_create:$g,saveToString:m_,scene_click:n_,scene_create:t_,scene_mouseDown:f_,scene_mouseMove:i_,scene_mouseUp:p_,scene_update:r_,setup:ov,voxelmap_clear:Z_,voxelmap_create_voxel_map:K_,voxelmap_generate_mesh:ev,voxelmap_getVoxel:$_,voxelmap_getVoxelColor:Q_,voxelmap_getVoxels:J_,voxelmap_paintFlood:rv,voxelmap_paintVoxel:tv,voxelmap_redo:sv,voxelmap_removeVoxel:nv,voxelmap_setVoxel:iv,voxelmap_undo:av},Symbol.toStringTag,{value:"Module"}));Zm(gv),tc();class _v{value;listeners=[];constructor(e){this.value=e}listen(e){this.listeners.push(e);const t=this.listeners;return()=>{let r=t.indexOf(e);r!=-1&&t.splice(r,1)}}setValue(e){this.value=e,this.listeners.forEach(t=>{t(e)})}}const vv=document.getElementById("paint"),xv=document.getElementById("place"),bv=document.getElementById("delete"),yv=document.getElementById("eyedropper");var Et=(i=>(i[i.Place=0]="Place",i[i.Delete=1]="Delete",i[i.Paint=2]="Paint",i[i.Eyedropper=3]="Eyedropper",i))(Et||{});let pr=new _v(0);vv.addEventListener("click",()=>{pr.setValue(2)}),xv.addEventListener("click",()=>{pr.setValue(0)}),bv.addEventListener("click",()=>{pr.setValue(1)}),yv.addEventListener("click",()=>{pr.setValue(3)});let rc=document.getElementById("toolLabel");var Xn;(i=>{i.autosave="voxel__autosave"})(Xn||(Xn={}));const fr=1e7,ic=50;let Je=Mv();function us(i,e,t){return new P(i,e,t).subScalar(fr/2).multiplyScalar(ic).addScalar(25)}function Mv(){const i=localStorage.getItem(Xn.autosave);if(i){console.log("Loaded autosave!");const e=Ql(i);return hs(e),e}else return new Xi(fr,fr,fr)}function Sv(){Je.clear(),hs(Je)}function Ev(i){hs(i),Je.setVoxelCallback&&(i.setVoxelCallback=Je.setVoxelCallback),Je.removeVoxelCallback&&(i.removeVoxelCallback=Je.removeVoxelCallback),Je.undoStatusCallback&&(i.undoStatusCallback=Je.undoStatusCallback),Je=i}function hs(i){Xr.clear();const e=i.getVoxels();for(const t of e){const r=t.x,n=t.y,a=t.z,o=us(r,n,a),s=i.getVoxelColor(t),l=Xl.clone(!0);l.visible=!0;let c=Cr(Fn(s));const u=new lr({color:c});l.material=u,l.position.copy(o),Xr.add(l)}}const Tv="modulepreload",wv=function(i){return"/"+i},nc={},gt=function(i,e,t){let r=Promise.resolve();if(e&&e.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),o=a?.nonce||a?.getAttribute("nonce");r=Promise.allSettled(e.map(s=>{if(s=wv(s),s in nc)return;nc[s]=!0;const l=s.endsWith(".css"),c=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${s}"]${c}`))return;const u=document.createElement("link");if(u.rel=l?"stylesheet":Tv,l||(u.as="script"),u.crossOrigin="",u.href=s,o&&u.setAttribute("nonce",o),document.head.appendChild(u),l)return new Promise((m,d)=>{u.addEventListener("load",m),u.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${s}`)))})}))}function n(a){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=a,window.dispatchEvent(o),!o.defaultPrevented)throw a}return r.then(a=>{for(const o of a||[])o.status==="rejected"&&n(o.reason);return i().catch(n)})},Av={accepts:[]},ac=globalThis.showOpenFilePicker;async function Rv(i={}){const e={...Av,...i};if(ac&&!i._preferPolyfill)return ac(e);const t=document.createElement("input");t.type="file",t.multiple=e.multiple,t.accept=(e.accepts||[]).map(n=>[...(n.extensions||[]).map(a=>"."+a),...n.mimeTypes||[]]).flat().join(","),Object.assign(t.style,{position:"fixed",top:"-100000px",left:"-100000px"}),document.body.appendChild(t);const r=gt(()=>Promise.resolve().then(()=>Uv),void 0);return await new Promise(n=>{t.addEventListener("change",n,{once:!0}),t.click()}),t.remove(),r.then(n=>n.getFileHandlesFromInput(t))}const sc=globalThis.showSaveFilePicker;async function oc(i={}){if(sc&&!i._preferPolyfill)return sc(i);i._name&&(console.warn("deprecated _name, spec now have `suggestedName`"),i.suggestedName=i._name);const{FileSystemFileHandle:e}=await gt(async()=>{const{FileSystemFileHandle:r}=await Promise.resolve().then(()=>Pi);return{FileSystemFileHandle:r}},void 0),{FileHandle:t}=await gt(async()=>{const{FileHandle:r}=await import("./downloader-BsckYbKl.js").then(async n=>(await n.__tla,n));return{FileHandle:r}},[]);return new e(new t(i.suggestedName))}globalThis.DataTransferItem&&!DataTransferItem.prototype.getAsFileSystemHandle&&(DataTransferItem.prototype.getAsFileSystemHandle=async function(){const i=this.webkitGetAsEntry(),[{FileHandle:e,FolderHandle:t},{FileSystemDirectoryHandle:r},{FileSystemFileHandle:n}]=await Promise.all([gt(()=>import("./sandbox-jfH12Ei5.js").then(async a=>(await a.__tla,a)),[]),gt(()=>Promise.resolve().then(()=>ps),void 0),gt(()=>Promise.resolve().then(()=>Pi),void 0)]);return i.isFile?new n(new e(i,!1)):new r(new t(i,!1))});let lc;Ms={WritableStream:globalThis.WritableStream,TransformStream:globalThis.TransformStream,DOMException:globalThis.DOMException,Blob:globalThis.Blob,File:globalThis.File},{WritableStream:lc}=Ms;class Yr extends lc{#e;constructor(e){super(e),this.#e=e,Object.setPrototypeOf(this,Yr.prototype),this._closed=!1}async close(){this._closed=!0;const e=this.getWriter(),t=e.close();return e.releaseLock(),t}seek(e){return this.write({type:"seek",position:e})}truncate(e){return this.write({type:"truncate",size:e})}write(e){if(this._closed)return Promise.reject(new TypeError("Cannot write to a CLOSED writable stream"));const t=this.getWriter(),r=t.write(e);return t.releaseLock(),r}}Object.defineProperty(Yr.prototype,Symbol.toStringTag,{value:"FileSystemWritableFileStream",writable:!1,enumerable:!1,configurable:!0}),Object.defineProperties(Yr.prototype,{close:{enumerable:!0},seek:{enumerable:!0},truncate:{enumerable:!0},write:{enumerable:!0}}),globalThis.FileSystemFileHandle&&!globalThis.FileSystemFileHandle.prototype.createWritable&&!globalThis.FileSystemWritableFileStream&&(globalThis.FileSystemWritableFileStream=Yr);const Lr=Symbol("adapter");class ds{[Lr];name;kind;constructor(e){this.kind=e.kind,this.name=e.name,this[Lr]=e}async queryPermission(e={}){const{mode:t="read"}=e,r=this[Lr];if(r.queryPermission)return r.queryPermission({mode:t});if(t==="read")return"granted";if(t==="readwrite")return r.writable?"granted":"denied";throw new TypeError(`Mode ${t} must be 'read' or 'readwrite'`)}async requestPermission({mode:e="read"}={}){const t=this[Lr];if(t.requestPermission)return t.requestPermission({mode:e});if(e==="read")return"granted";if(e==="readwrite")return t.writable?"granted":"denied";throw new TypeError(`Mode ${e} must be 'read' or 'readwrite'`)}async remove(e={}){await this[Lr].remove(e)}async isSameEntry(e){return this===e?!0:!e||typeof e!="object"||this.kind!==e.kind||!e[Lr]?!1:this[Lr].isSameEntry(e[Lr])}}Object.defineProperty(ds.prototype,Symbol.toStringTag,{value:"FileSystemHandle",writable:!1,enumerable:!1,configurable:!0}),globalThis.FileSystemHandle&&(globalThis.FileSystemHandle.prototype.queryPermission??=function(i){return"granted"});let cc;Ki={INVALID:["seeking position failed.","InvalidStateError"],GONE:["A requested file or directory could not be found at the time an operation was processed.","NotFoundError"],MISMATCH:["The path supplied exists, but was not an entry of requested type.","TypeMismatchError"],MOD_ERR:["The object can not be modified in this way.","InvalidModificationError"],SYNTAX:i=>[`Failed to execute 'write' on 'UnderlyingSinkBase': Invalid params passed. ${i}`,"SyntaxError"],SECURITY:["It was determined that certain files are unsafe for access within a Web application, or that too many calls are being made on file resources.","SecurityError"],DISALLOWED:["The request is not allowed by the user agent or the platform in the current context.","NotAllowedError"]},cc={writable:globalThis.WritableStream};async function Cv(i){console.warn("deprecated fromDataTransfer - use `dt.items[0].getAsFileSystemHandle()` instead");const[e,t,r]=await Promise.all([gt(()=>import("./memory-Cgn29wzM.js").then(async a=>(await a.__tla,a)),[]),gt(()=>import("./sandbox-jfH12Ei5.js").then(async a=>(await a.__tla,a)),[]),gt(()=>Promise.resolve().then(()=>ps),void 0)]),n=new e.FolderHandle("",!1);return n._entries=i.map(a=>a.isFile?new t.FileHandle(a,!1):new t.FolderHandle(a,!1)),new r.FileSystemDirectoryHandle(n)}async function Lv(i){const{FolderHandle:e,FileHandle:t}=await gt(async()=>{const{FolderHandle:s,FileHandle:l}=await import("./memory-Cgn29wzM.js").then(async c=>(await c.__tla,c));return{FolderHandle:s,FileHandle:l}},[]),{FileSystemDirectoryHandle:r}=await gt(async()=>{const{FileSystemDirectoryHandle:s}=await Promise.resolve().then(()=>ps);return{FileSystemDirectoryHandle:s}},void 0),n=Array.from(i.files),a=n[0].webkitRelativePath.split("/",1)[0],o=new e(a,!1);return n.forEach(s=>{const l=s.webkitRelativePath.split("/");l.shift();const c=l.pop(),u=l.reduce((m,d)=>(m._entries[d]||(m._entries[d]=new e(d,!1)),m._entries[d]),o);u._entries[c]=new t(s.name,s,!1)}),new r(o)}async function Pv(i){const{FileHandle:e}=await gt(async()=>{const{FileHandle:r}=await import("./memory-Cgn29wzM.js").then(async n=>(await n.__tla,n));return{FileHandle:r}},[]),{FileSystemFileHandle:t}=await gt(async()=>{const{FileSystemFileHandle:r}=await Promise.resolve().then(()=>Pi);return{FileSystemFileHandle:r}},void 0);return Array.from(i.files).map(r=>new t(new e(r.name,r,!1)))}const Uv=Object.freeze(Object.defineProperty({__proto__:null,config:cc,errors:Ki,fromDataTransfer:Cv,getDirHandlesFromInput:Lv,getFileHandlesFromInput:Pv},Symbol.toStringTag,{value:"Module"})),{GONE:Dv,MOD_ERR:Iv}=Ki,Pr=Symbol("adapter");let jn=class $n extends ds{[Pr];constructor(e){super(e),this[Pr]=e}async getDirectoryHandle(e,t={}){if(e==="")throw new TypeError("Name can't be an empty string.");if(e==="."||e===".."||e.includes("/"))throw new TypeError("Name contains invalid characters.");t.create=!!t.create;const r=await this[Pr].getDirectoryHandle(e,t);return new $n(r)}async*entries(){const{FileSystemFileHandle:e}=await gt(async()=>{const{FileSystemFileHandle:t}=await Promise.resolve().then(()=>Pi);return{FileSystemFileHandle:t}},void 0);for await(const[t,r]of this[Pr].entries())yield[r.name,r.kind==="file"?new e(r):new $n(r)]}async*getEntries(){const{FileSystemFileHandle:e}=await gt(async()=>{const{FileSystemFileHandle:t}=await Promise.resolve().then(()=>Pi);return{FileSystemFileHandle:t}},void 0);console.warn("deprecated, use .entries() instead");for await(let t of this[Pr].entries())yield t.kind==="file"?new e(t):new $n(t)}async getFileHandle(e,t={}){const{FileSystemFileHandle:r}=await gt(async()=>{const{FileSystemFileHandle:a}=await Promise.resolve().then(()=>Pi);return{FileSystemFileHandle:a}},void 0);if(e==="")throw new TypeError("Name can't be an empty string.");if(e==="."||e===".."||e.includes("/"))throw new TypeError("Name contains invalid characters.");t.create=!!t.create;const n=await this[Pr].getFileHandle(e,t);return new r(n)}async removeEntry(e,t={}){if(e==="")throw new TypeError("Name can't be an empty string.");if(e==="."||e===".."||e.includes("/"))throw new TypeError("Name contains invalid characters.");return t.recursive=!!t.recursive,this[Pr].removeEntry(e,t)}async resolve(e){if(await e.isSameEntry(this))return[];const t=[{handle:this,path:[]}];for(;t.length;){let{handle:r,path:n}=t.pop();for await(const a of r.values()){if(await a.isSameEntry(e))return[...n,a.name];a.kind==="directory"&&t.push({handle:a,path:[...n,a.name]})}}return null}async*keys(){for await(const[e]of this[Pr].entries())yield e}async*values(){for await(const[e,t]of this)yield t}[Symbol.asyncIterator](){return this.entries()}};if(Object.defineProperty(jn.prototype,Symbol.toStringTag,{value:"FileSystemDirectoryHandle",writable:!1,enumerable:!1,configurable:!0}),Object.defineProperties(jn.prototype,{getDirectoryHandle:{enumerable:!0},entries:{enumerable:!0},getFileHandle:{enumerable:!0},removeEntry:{enumerable:!0}}),globalThis.FileSystemDirectoryHandle){const i=globalThis.FileSystemDirectoryHandle.prototype;i.resolve=async function(n){if(await n.isSameEntry(this))return[];const a=[{handle:this,path:[]}];for(;a.length;){let{handle:o,path:s}=a.pop();for await(const l of o.values()){if(await l.isSameEntry(n))return[...s,l.name];l.kind==="directory"&&a.push({handle:l,path:[...s,l.name]})}}return null};async function e(n){if(await(await navigator.storage.getDirectory()).resolve(n)===null)throw new DOMException(...Dv)}const t=i.entries;i.entries=async function*(){await e(this),yield*t.call(this)},i[Symbol.asyncIterator]=async function*(){yield*this.entries()};const r=i.removeEntry;i.removeEntry=async function(n,a={}){return r.call(this,n,a).catch(async o=>{throw o instanceof DOMException&&o.name==="UnknownError"&&!a.recursive&&!(await t.call(this).next()).done?new DOMException(...Iv):o})}}const ps=Object.freeze(Object.defineProperty({__proto__:null,FileSystemDirectoryHandle:jn,default:jn},Symbol.toStringTag,{value:"Module"})),{INVALID:Nv,SYNTAX:fs,GONE:Ov}=Ki,qn=Symbol("adapter");class Yn extends ds{[qn];constructor(e){super(e),this[qn]=e}async createWritable(e={}){return new Yr(await this[qn].createWritable(e))}async getFile(){return this[qn].getFile()}}if(Object.defineProperty(Yn.prototype,Symbol.toStringTag,{value:"FileSystemFileHandle",writable:!1,enumerable:!1,configurable:!0}),Object.defineProperties(Yn.prototype,{createWritable:{enumerable:!0},getFile:{enumerable:!0}}),globalThis.FileSystemFileHandle&&!globalThis.FileSystemFileHandle.prototype.createWritable){const i=new WeakMap;let e;const t=()=>{let n,a;onmessage=async o=>{const s=o.ports[0],l=o.data;switch(l.type){case"open":const c=l.name;let u=await navigator.storage.getDirectory();for(const m of l.path)u=await u.getDirectoryHandle(m);n=await u.getFileHandle(c),a=await n.createSyncAccessHandle();break;case"write":a.write(l.data,{at:l.position}),a.flush();break;case"truncate":a.truncate(l.size);break;case"abort":case"close":a.close();break}s.postMessage(0)}};globalThis.FileSystemFileHandle.prototype.createWritable=async function(n){if(!e){const p=`(${t.toString()})()`,g=new Blob([p],{type:"text/javascript"});e=URL.createObjectURL(g)}const a=new Worker(e,{type:"module"});let o=0;const s=new TextEncoder;let l=await this.getFile().then(p=>p.size);const c=p=>new Promise((g,v)=>{const f=new MessageChannel;f.port1.onmessage=h=>{h.data instanceof Error?v(h.data):g(h.data),f.port1.close(),f.port2.close(),f.port1.onmessage=null},a.postMessage(p,[f.port2])}),u=await navigator.storage.getDirectory(),m=await i.get(this),d=await u.resolve(m);if(d===null)throw new DOMException(...Ov);return await c({type:"open",path:d,name:this.name}),n?.keepExistingData===!1&&(await c({type:"truncate",size:0}),l=0),new Yr({start:p=>{},async write(p){if(p?.constructor===Object?p={...p}:p={type:"write",data:p,position:o},p.type==="write"){if(!("data"in p))throw await c({type:"close"}),new DOMException(...fs("write requires a data argument"));if(p.position??=o,typeof p.data=="string")p.data=s.encode(p.data);else if(p.data instanceof ArrayBuffer)p.data=new Uint8Array(p.data);else if(!(p.data instanceof Uint8Array)&&ArrayBuffer.isView(p.data))p.data=new Uint8Array(p.data.buffer,p.data.byteOffset,p.data.byteLength);else if(!(p.data instanceof Uint8Array)){const g=await new Response(p.data).arrayBuffer();p.data=new Uint8Array(g)}Number.isInteger(p.position)&&p.position>=0&&(o=p.position),o+=p.data.byteLength,l+=p.data.byteLength}else if(p.type==="seek")if(Number.isInteger(p.position)&&p.position>=0){if(l<p.position)throw new DOMException(...Nv);console.log("seeking",p),o=p.position;return}else throw await c({type:"close"}),new DOMException(...fs("seek requires a position argument"));else if(p.type==="truncate")if(Number.isInteger(p.size)&&p.size>=0)l=p.size,o>l&&(o=l);else throw await c({type:"close"}),new DOMException(...fs("truncate requires a size argument"));await c(p)},async close(){await c({type:"close"}),a.terminate()},async abort(p){await c({type:"abort",reason:p}),a.terminate()}})};const r=FileSystemDirectoryHandle.prototype.getFileHandle;FileSystemDirectoryHandle.prototype.getFileHandle=async function(...n){const a=await r.call(this,...n);return i.set(a,this),a}}const Pi=Object.freeze(Object.defineProperty({__proto__:null,FileSystemFileHandle:Yn,default:Yn},Symbol.toStringTag,{value:"Module"})),Fv=document.getElementById("newFile"),Bv=document.getElementById("loadFile"),zv=document.getElementById("saveFile"),Hv=document.getElementById("exportFile");let ji="unnamed",kv=5*60*1e3;setInterval(()=>{console.log("Autosaving...");const i=Jl(Je);localStorage.setItem(Xn.autosave,i),console.log("Autosaving complete!")},kv),Fv.addEventListener("click",()=>{Sv()}),Bv.addEventListener("click",async()=>{const[i]=await Rv({accepts:[{accept:{"application/json":[".json"]}}],multiple:!1});ji=i.name.split(".")[0];const e=await(await i.getFile()).text(),t=Ql(e);Ev(t)}),zv.addEventListener("click",async()=>{const i=await oc({suggestedName:`${ji}.json`,types:[{accept:{"application/json":[".json"]}}]});ji=i.name.split(".")[0];const e=Jl(Je),t=await i.createWritable();await t.write(e),await t.close()}),Hv.addEventListener("click",async()=>{const i=await oc({suggestedName:`${ji}.zip`,types:[{accept:{"application/zip":[".zip"]}}]}),e=Je.generate_mesh(1,1024,50),t=eg(ji,e),r=await i.createWritable();await r.write(t),await r.close()});const ms=document.getElementById("undoButton"),gs=document.getElementById("redoButton");ms.disabled=!0,gs.disabled=!0,Je.undoStatusCallback=(i,e)=>{ms.disabled=i,gs.disabled=e},ms.addEventListener("click",()=>{Je.undo()}),gs.addEventListener("click",()=>{Je.redo()}),og();let Kn=new Pm,Zn=new Me;function uc(i){switch(i){case Et.Delete:case Et.Eyedropper:case Et.Paint:Bt.visible=!1;break;case Et.Place:Bt.visible=!0;break}}rc.innerText=`Current Tool: ${Et[pr.value]}`,pr.listen(i=>{uc(i),rc.innerText=`Current Tool: ${Et[i]}`}),Ar.addEventListener("mouseleave",()=>{Bt.visible=!1}),Ar.addEventListener("mouseenter",()=>{uc(pr.value)});function hc(i){const e=Ar.getBoundingClientRect();return{x:i.clientX-e.left,y:i.clientY-e.top}}function Gv(){const i=new wm(16777215,16777215,3);i.color.setRGB(.6,.6,.6),i.position.set(0,50,0),cr.add(i);const e=new Cm(new Re(1,1,1),6);e.position.set(-1,1.75,1),e.position.multiplyScalar(30),e.lookAt(new P(0,0,0)),cr.add(e),cr.add(jm),cr.add(ns),cr.background=new Re(.95,.95,.95),cr.add(Bt),Gi.add(Ai),document.addEventListener("pointermove",Wv),document.addEventListener("pointerdown",Xv),window.addEventListener("resize",Vv),Hl()}function Vv(){ur.aspect=window.innerWidth/window.innerHeight,ur.updateProjectionMatrix(),Vi.setSize(window.innerWidth,window.innerHeight),Vi.setPixelRatio(Math.min(window.devicePixelRatio,2)),On.setSize(window.innerWidth,window.innerHeight)}function dc(i,e,t=1e-4){return Math.abs(i.x-e.x)<t&&Math.abs(i.y-e.y)<t&&Math.abs(i.z-e.z)<t}Je.removeVoxelCallback=(i,e,t)=>{let r=us(i,e,t);for(const n of Xr.children)if(dc(n.position,r)){Xr.remove(n);break}},Je.setVoxelCallback=(i,e)=>{let[t,r,n]=i,a=us(t,r,n);for(const c of Xr.children)if(dc(c.position,a)){let u=Cr(Fn(e));const m=new lr({color:u});let d=c;d.material=m;return}const o=Xl.clone(!0);o.visible=!0;let s=Cr(Fn(e));const l=new lr({color:s});o.material=l,o.position.copy(a),Xr.add(o)};let qi=null;function Wv(i){if(i.target!==Ar)return;let e=hc(i);Zn.set(e.x/window.innerWidth*2-1,-(e.y/window.innerHeight)*2+1),Kn.setFromCamera(Zn,ur);const t=Kn.intersectObjects(Gi.children,!0);if(jr.selectedObjects=[],qi){let r=qi.position.clone().divideScalar(50).floor();r.addScalar(fr/2);let n=Je.getVoxel(r.x,r.y,r.z);if(n){const a=Je.getVoxelColor(n);let o=Cr(Fn(a));const s=new lr({color:o});qi.material=s}qi=null}if(t.length>0){const r=t[0];switch(pr.value){case Et.Place:if(Bt.material=new lr({color:Cr(wi())}),Bt.position.copy(r.point).add(r.face?.normal),Bt.position.divideScalar(50).floor().multiplyScalar(50).addScalar(25),Bt.position.y<0){Bt.visible=!1;break}Bt.visible=!0;break;case Et.Paint:{let n=r.object;if(n!==Ai){const a=new lr({color:Cr(wi())});n.material=a}break}case Et.Delete:{let n=r.object;if(n!==Ai){const a=new lr({color:16711680});n.material=a}break}case Et.Eyedropper:{let n=r.object;n!==Ai&&(jr.selectedObjects=[n]);break}}r.object!==Ai&&(qi=r.object)}else Bt.visible=!1}function Xv(i){if(i.button!==0||i.target!==Ar)return;let e=hc(i);Zn.set(e.x/window.innerWidth*2-1,-(e.y/window.innerHeight)*2+1),Kn.setFromCamera(Zn,ur);const t=Kn.intersectObjects(Gi.children,!0);if(t.length>0){const r=t[0];switch(pr.value){case Et.Place:let n=r.point.add(r.face?.normal);if(n.divideScalar(ic).floor(),n.y<0)break;n.addScalar(fr/2),Je.setVoxel(n.x,n.y,n.z,Gl(wi()));break;case Et.Paint:{const a=r.object;let o=a.position.clone().divideScalar(50).floor();if(o.addScalar(fr/2),Je.getVoxel(o.x,o.y,o.z)){Je.paintVoxel(o.x,o.y,o.z,Gl(wi()));const s=new lr({color:Cr(wi())});a.material=s}break}case Et.Delete:{const a=r.object;let o=a.position.clone().divideScalar(50).floor();o.addScalar(fr/2),Je.getVoxel(o.x,o.y,o.z)&&(a.removeFromParent(),Je.removeVoxel(o.x,o.y,o.z));break}case Et.Eyedropper:{let a=r.object.position.clone().divideScalar(50).floor();a.addScalar(fr/2);let o=Je.getVoxel(a.x,a.y,a.z);if(o){let s=Je.getVoxelColor(o);qm(s)}break}}}}Gv()})();export{Jv as __tla,Ms as c,Ki as e};
